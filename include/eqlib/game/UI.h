...
constexpr size_t CButtonWnd_size = 0x328; // @sizeof(CButtonWnd) :: 2025-10-13 (live) @ 0x1405D7EA0
...
constexpr size_t CBuffWindow_size = 0x330; // @sizeof(CBuffWindow) :: 2025-10-13 (live) @ 0x14019452F
...
constexpr size_t CCursorAttachment_size = 0x608; // @sizeof(CCursorAttachment) :: 2025-10-13 (live) @ 0x1401938C8
...
constexpr size_t CFindItemWnd_size = 0x3D8; // @sizeof(CFindItemWnd) :: 2025-10-13 (live) @ 0x140194F56
...
constexpr size_t CFindLocationWnd_size = 0x7A0; // @sizeof(CFindLocationWnd) :: 2025-10-13 (live) @ 0x140195714
...
private:
/*0x398*/ CListWnd*     m_findLocationList;              // FLW_FindLocationList
/*0x3a0*/ CCheckBoxWnd* m_filterLocationsCheckBox;       // FLW_FilterLocationsCheckbox
/*0x3a8*/ CCheckBoxWnd* m_filterGroupCheckBox;           // FLW_FilterGroupCheckbox
/*0x3b0*/ CCheckBoxWnd* m_filterRaidCheckBox;            // FLW_FilterRaidCheckbox
/*0x3b8*/ CStmlWnd*     m_noneLabel;                     // FLW_NoneFoundLabel
...
/*0x3c0*/ UIListComponent         findLocationListComponent;
/*0x460*/ UIButtonComponent       filterLocationsCheckBoxComponent;
/*0x508*/ UIButtonComponent       filterGroupCheckBoxComponent;
...
constexpr size_t CGiveWnd_size = 0xB30; // @sizeof(CGiveWnd) :: 2025-10-13 (live) @ 0x1401951C6
...
/*0x3a8*/ CButtonWnd*        m_moneyButton[eNumMoneySlotTypes];
/*0x3c8*/ CButtonWnd*        m_tradeButton;
/*0x3d0*/ CButtonWnd*        m_cancelButton;
/*0x3d8*/ CStmlWnd*          m_giveNameLabel;
/*0x3e0*/ CInvSlotWnd*       m_invSlotWnd[MAX_GIVE_SLOTS];
...
/*0x400*/ UIButtonComponent  MoneyButtonComponent[eNumMoneySlotTypes];
/*0x6a0*/ UIButtonComponent  TradeButtonComponent;
/*0x748*/ UIButtonComponent  CancelButtonComponent;
/*0x7f0*/ UIStmlComponent    GiveNameComponent;
/*0x890*/ UIInvSlotComponent ItemSlotComponents[MAX_GIVE_SLOTS];
/*0xb30*/
};
...
constexpr size_t CGroupWnd_size = 0x6E0; // @sizeof(CGroupWnd) :: 2025-10-13 (live) @ 0x140194047
...
constexpr size_t CItemDisplayWnd_size = 0xA88; // @sizeof(CItemDisplayWnd) :: 2025-10-13 (live) @ 0x14042A744
...
constexpr size_t CKeyRingWnd_size = 0x448; // @sizeof(CKeyRingWnd) :: 2025-10-13 (live) @ 0x1401949B5
...
/*0x3a8*/ bool          bListDirty[eNumPages];
/*0x3ae*/ bool          bStatDirty[eNumPages];
/*0x3b4*/ int           ForcedSelection[eNumPages];
...
/*0x3f0*/ bool          KeysListDirty;
/*0x3f4*/ int           ForcedKeysSelection;
...
/*0x430*/ CPageWnd*     pPageActivated;                  // KRW_ActivatedItems_Page
...
{
public:
/*0x3a0*/ ClaimFeatureDataCollection claimFeatureData;
/*0x3d8*/
private:
	// If New UI is enabled, these members will not be initialized, and the components will be used instead. Use the
	// Accessors below instead.
/*0x3b8*/ CListWnd*                  m_pListFeatures;         // ClaimFeatureList
/*0x3c0*/ CListWnd*                  m_pListItems;            // ClaimItemList
/*0x3c8*/ CButtonWnd*                m_pRefreshButton;        // ClaimRefreshButton
/*0x3d0*/ CButtonWnd*                m_pClaimButton;          // ClaimClaimButton
/*0x3d8*/ CButtonWnd*                m_pCancelButton;         // ClaimCancelButton
/*0x3e0*/ CStmlWnd*                  m_pItemDescription;      // ClaimItemDescription
...
/*0x3e8*/ UIListComponent            FeatureListComponent; // 408
/*0x488*/ UIListComponent            ItemListComponent; // 4a8
/*0x528*/ UIButtonComponent          RefreshButtonComponent; // 548
/*0x5d0*/ UIButtonComponent          ClaimButtonComponent; // 5f0
/*0x678*/ UIButtonComponent          CancelButtonComponent; // 698
/*0x720*/ UIStmlComponent            ItemDescriptionComponent; // 740
/*0x7c0*/
};
...
constexpr size_t CLootWnd_size = 0xCA0; // @sizeof(CLootWnd) :: 2025-10-13 (live) @ 0x140194C84
...
constexpr size_t CMapViewWnd_size = 0x818; // @sizeof(CMapViewWnd) :: 2025-10-13 (live) @ 0x1401943A9
...
/*0x2c0*/ KeyboardAssignmentData   Binds[0xA1];
/*0xcd0*/
/*0x904*/
};
...
constexpr size_t CPetInfoWnd_size = 0x3B0; // @sizeof(CPetInfoWnd) :: 2025-10-13 (live) @ 0x140193E6F
...
constexpr size_t CPlayerWnd_size = 0x3E8; // @sizeof(CPlayerWnd) :: 2025-10-13 (live) @ 0x1401947DD
...
constexpr size_t CSpellDisplayWnd_size = 0x398; // @sizeof(CSpellDisplayWnd) :: 2025-10-13 (live) @ 0x1404FB7FE
...
/*0x388*/ int                SpellID;
/*0x38c*/ int                Unknown;                   // Used in 3rd param of spell tag string %d
...
constexpr size_t CTargetWnd_size = 0x3A8; // @sizeof(CTargetWnd) :: 2025-10-13 (live) @ 0x14019467E
...
constexpr size_t CTradeWnd_size = 0x1728; // @sizeof(CTradeWnd) :: 2025-10-13 (live) @ 0x140194E6C
...
/*0x039c*/ unsigned int       NextRefreshTime;
/*0x03a0*/ bool               bInventoryWasOpen;

private:
	// If New UI is enabled, these members will not be initialized, and the components will be used instead. Use the
	// Accessors below instead.
/*0x03a8*/ CButtonWnd*        m_hisMoneyButton[eNumMoneySlotTypes];
/*0x03c8*/ CButtonWnd*        m_myMoneyButton[eNumMoneySlotTypes];
/*0x03e8*/ CButtonWnd*        m_tradeButton;
/*0x03f0*/ CButtonWnd*        m_cancelButton;
/*0x03f8*/ CStmlWnd*          m_hisNameLabel;
/*0x0400*/ CStmlWnd*          m_myNameLabel;
/*0x0408*/ CInvSlotWnd*       m_invSlotWnds[MAX_TRADE_SLOTS];
...
/*0x0488*/ UIButtonComponent  HisMoneyComponent[eNumMoneySlotTypes];
/*0x0728*/ UIButtonComponent  MyMoneyComponent[eNumMoneySlotTypes];
/*0x09c8*/ UIButtonComponent  TradeButtonComponent;
/*0x0a70*/ UIButtonComponent  CancelButtonComponent;
/*0x0b18*/ UIStmlComponent    OtherNameComponent;
/*0x0bb8*/ UIStmlComponent    SelfNameComponent;
/*0x0c58*/ UIInvSlotComponent TradeSlotComponent[16];

/*0x16d8*/ long               HisMoney[eNumMoneySlotTypes];
/*0x16e8*/ long               MyMoney[eNumMoneySlotTypes];
/*0x16f8*/ ItemContainer      TradeItems;
/*0x1720*/ bool               bHisReadyTrade;           // was HisTradeReady
/*0x1721*/ bool               bMyReadyTrade;            // was MyTradeReady
/*0x1722*/ bool               bIsTrading;               // was TradeWndOpen
/*0x1724*/
...
constexpr size_t ZoneGuideManagerClient_size = 0xFA50; // @sizeof(ZoneGuideManagerClient) :: 2025-10-13 (live) @ 0x14034D2DF
