...
constexpr size_t CButtonWnd_size = 0x350; // @sizeof(CButtonWnd) :: 2025-10-07 (test) @ 0x1405D6E30
...
constexpr size_t CBuffWindow_size = 0x358; // @sizeof(CBuffWindow) :: 2025-10-07 (test) @ 0x14019457F
...
constexpr size_t CCursorAttachment_size = 0x630; // @sizeof(CCursorAttachment) :: 2025-10-07 (test) @ 0x140193918
...
constexpr size_t CFindItemWnd_size = 0x400; // @sizeof(CFindItemWnd) :: 2025-10-07 (test) @ 0x140194FA6
...
constexpr size_t CFindLocationWnd_size = 0x7C8; // @sizeof(CFindLocationWnd) :: 2025-10-07 (test) @ 0x140195764
...
constexpr size_t CGiveWnd_size = 0xB58; // @sizeof(CGiveWnd) :: 2025-10-07 (test) @ 0x140195216
...
constexpr size_t CGroupWnd_size = 0x708; // @sizeof(CGroupWnd) :: 2025-10-07 (test) @ 0x140194097
...
constexpr size_t CItemDisplayWnd_size = 0xAB0; // @sizeof(CItemDisplayWnd) :: 2025-10-07 (test) @ 0x140429774
...
constexpr size_t CKeyRingWnd_size = 0x470; // @sizeof(CKeyRingWnd) :: 2025-10-07 (test) @ 0x140194A05
...
{
public:
/*0x3c8*/ ClaimFeatureDataCollection claimFeatureData;
/*0x3d8*/
private:
	// If New UI is enabled, these members will not be initialized, and the components will be used instead. Use the
	// Accessors below instead.
/*0x3e0*/ CListWnd*                  m_pListFeatures;         // ClaimFeatureList
/*0x3e8*/ CListWnd*                  m_pListItems;            // ClaimItemList
/*0x3f0*/ CButtonWnd*                m_pRefreshButton;        // ClaimRefreshButton
/*0x3f8*/ CButtonWnd*                m_pClaimButton;          // ClaimClaimButton
/*0x400*/ CButtonWnd*                m_pCancelButton;         // ClaimCancelButton
/*0x408*/ CStmlWnd*                  m_pItemDescription;      // ClaimItemDescription
...
/*0x410*/ UIListComponent            FeatureListComponent; // 408
/*0x4b0*/ UIListComponent            ItemListComponent; // 4a8
/*0x550*/ UIButtonComponent          RefreshButtonComponent; // 548
/*0x5f8*/ UIButtonComponent          ClaimButtonComponent; // 5f0
/*0x6a0*/ UIButtonComponent          CancelButtonComponent; // 698
/*0x748*/ UIStmlComponent            ItemDescriptionComponent; // 740
/*0x7e8*/
};
...
constexpr size_t CLootWnd_size = 0xCC8; // @sizeof(CLootWnd) :: 2025-10-07 (test) @ 0x140194CD4
...
constexpr size_t CMapViewWnd_size = 0x868; // @sizeof(CMapViewWnd) :: 2025-10-07 (test) @ 0x1401943F9
...
constexpr size_t CPetInfoWnd_size = 0x3D8; // @sizeof(CPetInfoWnd) :: 2025-10-07 (test) @ 0x140193EBF
...
constexpr size_t CPlayerWnd_size = 0x410; // @sizeof(CPlayerWnd) :: 2025-10-07 (test) @ 0x14019482D
...
constexpr size_t CSpellDisplayWnd_size = 0x3C0; // @sizeof(CSpellDisplayWnd) :: 2025-10-07 (test) @ 0x1404FA86E
...
constexpr size_t CTargetWnd_size = 0x3D0; // @sizeof(CTargetWnd) :: 2025-10-07 (test) @ 0x1401946CE
...
constexpr size_t CTradeWnd_size = 0x1750; // @sizeof(CTradeWnd) :: 2025-10-07 (test) @ 0x140194EBC
...
constexpr size_t ZoneGuideManagerClient_size = 0xFA50; // @sizeof(ZoneGuideManagerClient) :: 2025-10-07 (test) @ 0x14034C4EF
