...
constexpr size_t CButtonWnd_size = 0x340; // @sizeof(CButtonWnd) :: 2025-11-03 (test) @ 0x1405E0350
...
constexpr size_t CBuffWindow_size = 0x348; // @sizeof(CBuffWindow) :: 2025-11-03 (test) @ 0x14019616F
...
constexpr size_t CCursorAttachment_size = 0x620; // @sizeof(CCursorAttachment) :: 2025-11-03 (test) @ 0x140195508
...
constexpr size_t CFindItemWnd_size = 0x3F8; // @sizeof(CFindItemWnd) :: 2025-11-03 (test) @ 0x140196B96
...
/*0x390*/ CButtonWnd*         FIW_AutoUnlock;
...
constexpr size_t CFindLocationWnd_size = 0x7B8; // @sizeof(CFindLocationWnd) :: 2025-11-03 (test) @ 0x140197354
...
constexpr size_t CGiveWnd_size = 0xB48; // @sizeof(CGiveWnd) :: 2025-11-03 (test) @ 0x140196E06
...
constexpr size_t CGroupWnd_size = 0x6F8; // @sizeof(CGroupWnd) :: 2025-11-03 (test) @ 0x140195C87
...
constexpr size_t CItemDisplayWnd_size = 0xAA0; // @sizeof(CItemDisplayWnd) :: 2025-11-03 (test) @ 0x140432084
...
constexpr size_t CKeyRingWnd_size = 0x4A0; // @sizeof(CKeyRingWnd) :: 2025-11-03 (test) @ 0x1401965F5
...
/*0x378*/ CButtonWnd*   pBtnStat[eNumPages];     // KRW_Mounts_Selected, KRW_Illusions_Selected, KRW_Familiars_Selected, KRW_HeroForge_SlotButton
/*0x3b0*/ CButtonWnd*   pBtnSlot[eNumPages];     // KRW_Mounts_SlotButton, KRW_Illusions_SlotButton, KRW_Familiars_SlotButton
/*0x3e8*/ bool          bListDirty[eNumPages];
/*0x3ef*/ bool          bStatDirty[eNumPages];
/*0x3f8*/ int           ForcedSelection[eNumPages];
/*0x418*/ CButtonWnd*   pItemBtnTemplate;                // KRW_ItemBtnTemplate
/*0x420*/ CButtonWnd*   pBtnFamiliarLeave;               // KRW_Familiars_LeaveButton
/*0x428*/ CButtonWnd*   pBtnFamiliarAutoLeave;           // KRW_Familiars_AutoLeaveButton
/*0x430*/ CButtonWnd*   pBtnStoreEquipmentSets;          // KRW_Equipment_StoreEquipmentSetsButton
/*0x438*/ CListWnd*     pKeysList;                       // KRW_Keys_List
/*0x440*/ bool          KeysListDirty;
/*0x444*/ int           ForcedKeysSelection;
/*0x448*/ int           LastUpdateTime;                  // timestamp of when the current tab was last updated.
/*0x450*/ CPageWnd*     pPageMounts;                     // KRW_Mounts_Page
/*0x458*/ CPageWnd*     pPageIllusions;                  // KRW_Illusions_Page
/*0x460*/ CPageWnd*     pPageFamiliars;                  // KRW_Familiars_Page
/*0x468*/ CPageWnd*     pPageKeys;                       // KRW_Keys_Page
/*0x470*/ CPageWnd*     pPageHeroForge;                  // KRW_HeroForge_Page
/*0x478*/ CPageWnd*     pPageTeleportation;              // KRW_TeleportationItems_Page
/*0x480*/ CPageWnd*     pPageActivated;                  // KRW_ActivatedItems_Page
/*0x488*/ CPageWnd*     pPageEquipmen;                   // KRW_EquipmentItems_Page
/*0x490*/ CTabWnd*      pTabBox;                         // KRW_Subwindows
/*0x498*/ KeyRingPages  CurrentPage;
/*0x49c*/
};
...
constexpr size_t CLootWnd_size = 0xCB8; // @sizeof(CLootWnd) :: 2025-11-03 (test) @ 0x1401968C4
...
constexpr size_t CMapViewWnd_size = 0x848; // @sizeof(CMapViewWnd) :: 2025-11-03 (test) @ 0x140195FE9
...
constexpr size_t CPetInfoWnd_size = 0x3C8; // @sizeof(CPetInfoWnd) :: 2025-11-03 (test) @ 0x140195AAF
...
constexpr size_t CPlayerWnd_size = 0x400; // @sizeof(CPlayerWnd) :: 2025-11-03 (test) @ 0x14019641D
...
constexpr size_t CSpellDisplayWnd_size = 0x3B0; // @sizeof(CSpellDisplayWnd) :: 2025-11-03 (test) @ 0x140503B6E
...
constexpr size_t CTargetWnd_size = 0x3C0; // @sizeof(CTargetWnd) :: 2025-11-03 (test) @ 0x1401962BE
...
constexpr size_t CTradeWnd_size = 0x1740; // @sizeof(CTradeWnd) :: 2025-11-03 (test) @ 0x140196AAC
...
constexpr size_t ZoneGuideManagerClient_size = 0xFA50; // @sizeof(ZoneGuideManagerClient) :: 2025-11-03 (test) @ 0x140350A6F
