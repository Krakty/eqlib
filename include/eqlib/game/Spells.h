...
constexpr size_t EQ_Spell_size = 0x218; // @sizeof(EQ_Spell) :: 2026-03-03 (test) @ 0x1401E2697
...
constexpr size_t ClientSpellManager_size = 0x22C0; // @sizeof(ClientSpellManager) :: 2026-03-03 (test) @ 0x1402783A0
