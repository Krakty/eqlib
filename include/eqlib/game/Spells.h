...
constexpr size_t EQ_Spell_size = 0x218; // @sizeof(EQ_Spell) :: 2026-01-27 (test) @ 0x1401DEE47
...
constexpr size_t ClientSpellManager_size = 0x22C0; // @sizeof(ClientSpellManager) :: 2026-01-27 (test) @ 0x140274BF0
