...
constexpr size_t CXWnd_size = 0x268; // @sizeof(CXWnd) :: 2026-01-16 (live) @ 0x1405EDB41
...
/*0x038*/ CLayoutStrategy*   pLayoutStrategy;
/*0x040*/ CXRect             TransitionRect;
/*0x050*/ uint32_t           LastBlinkFadeRefreshTime;
/*0x054*/ uint32_t           BackgroundDrawType;
/*0x058*/ CXRect             IconRect;
/*0x068*/ COLORREF           DisabledBackground;
/*0x070*/ CXStr              XMLToolTip;
/*0x078*/ bool               bShowClickThroughMenuItem;
/*0x079*/ bool               bClickThroughToBackground;
/*0x07a*/ bool               bIsTransitioning;
/*0x07b*/ bool               bScreenClipRectChanged;
/*0x07c*/ int                HScrollMax;
/*0x080*/ bool               bMaximizable;
/*0x081*/ bool               Fades;
/*0x082*/ bool               bClientClipRectChanged;
/*0x084*/ int                DeleteCount;
/*0x088*/ int                ZLayer;
/*0x08c*/ uint32_t           LastTimeMouseOver;
/*0x090*/ bool               bBottomAnchoredToTop;
/*0x091*/ bool               Faded;
/*0x092*/ bool               bCaptureTitle;
/*0x093*/ bool               bClickThrough;
/*0x094*/ bool               MouseOver;
/*0x098*/ int                HScrollPos;
/*0x09c*/ bool               Locked;
/*0x09d*/ bool               bClipToParent;
/*0x09e*/ bool               bEscapableLocked;
/*0x0a0*/ int                VScrollPos;
/*0x0a8*/ CXStr              Tooltip;
/*0x0b0*/ bool               bMaximized;
/*0x0b1*/ bool               bRightAnchoredToLeft;
/*0x0b2*/ bool               bAction;
/*0x0b3*/ bool               bNeedsSaving;
/*0x0b4*/ int                ParentAndContextMenuArrayIndex;
/*0x0b8*/ CXRect             ClipRectScreen;
/*0x0c8*/ uint32_t           XMLIndex;
/*0x0cc*/ bool               bShowBorder;
/*0x0d0*/ CTextureAnimation* IconTextureAnim;
/*0x0d8*/ COLORREF           BGColor;
/*0x0dc*/ bool               bClickThroughMenuItemStatus;
/*0x0e0*/ uint32_t           BlinkFadeStartTime;
/*0x0e4*/ uint32_t           TransitionDuration;
/*0x0e8*/ bool               bIsParentOrContextMenuWindow;
/*0x0ec*/ int                LeftOffset;
/*0x0f0*/ bool               bEscapable;
/*0x0f4*/ int                BlinkStartTimer;
/*0x0f8*/ CXWnd*             ParentWindow;
/*0x100*/ bool               Enabled;
/*0x101*/ uint8_t            TargetAlpha;
/*0x102*/ bool               Unlockable;
/*0x104*/ int                Transition;
/*0x108*/ int                managerArrayIndex;
/*0x110*/ CXWndDrawTemplate* DrawTemplate;
/*0x118*/ bool               bLeftAnchoredToLeft;
/*0x11c*/ COLORREF           CRNormal;
/*0x120*/ int                RightOffset;
/*0x124*/ uint8_t            Alpha;
...
/*0x140*/ uint8_t            FadeToAlpha;
/*0x148*/ ArrayClass2<uint32_t> RuntimeTypes;
/*0x168*/ int                TopOffset;
/*0x16c*/ bool               bBringToTopWhenClicked;
/*0x16d*/ bool               bActive;
/*0x170*/ CXStr              DataStr;
/*0x178*/ bool               bFullyScreenClipped;
/*0x17c*/ CXRect             Location;
/*0x18c*/ uint32_t           WindowStyle;
/*0x190*/ CXStr              WindowText;
/*0x198*/ bool               bTiled;
/*0x199*/ bool               Minimized;
/*0x19a*/ uint8_t            bResizableMask;
/*0x19c*/ uint32_t           FadeDelay;
/*0x1a0*/ uint32_t           FadeDuration;
/*0x1a4*/ CXSize             MaxClientSize;
/*0x1ac*/ bool               bEnableShowBorder;
...
constexpr size_t CSidlScreenWnd_size = 0x2D0; // @sizeof(CSidlScreenWnd) :: 2026-01-16 (live) @ 0x1405E85C1
...
constexpr size_t CEQXWndManager_size = 0x298; // @sizeof(CEQXWndManager) :: 2026-01-16 (live) @ 0x14019C385
