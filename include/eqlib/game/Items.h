...
constexpr size_t ItemDefinition_size = 0x688; // @sizeof(ItemDefinition) :: 2026-04-07 (test)
...
/*0x0c8*/ int                   Charges;
/*0x0cc*/ int                   NoteStatus;
/*0x0d0*/ bool                  bConvertable;
