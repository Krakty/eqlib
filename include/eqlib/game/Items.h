...
constexpr size_t ItemDefinition_size = 0x640; // @sizeof(ItemDefinition) :: 2025-12-09 (test) @ 0x14021C584
...
constexpr size_t ItemClient_size = 0x138; // @sizeof(ItemClient) :: 2025-12-09 (test) @ 0x1401E4C19
