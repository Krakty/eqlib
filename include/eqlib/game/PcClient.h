...
constexpr size_t CGroupMember_size = 0x68; // @sizeof(CGroupMember) :: 2025-11-10 (live) @ 0x1402DE074
...
constexpr size_t PcClient_size = 0x3288; // @sizeof(PcClient) :: 2025-11-10 (live) @ 0x140284B4B
