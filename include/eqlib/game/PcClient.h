...
constexpr size_t CGroupMember_size = 0x68; // @sizeof(CGroupMember) :: 2025-10-22 (test) @ 0x1402DAE6B
...
constexpr size_t PcClient_size = 0x3218; // @sizeof(PcClient) :: 2025-10-22 (test) @ 0x1402827EB
