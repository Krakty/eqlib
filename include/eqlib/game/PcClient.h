...
constexpr size_t CGroupMember_size = 0x68; // @sizeof(CGroupMember) :: 2026-01-13 (test) @ 0x1402E2816
...
constexpr size_t PcClient_size = 0x3288; // @sizeof(PcClient) :: 2026-01-13 (test) @ 0x1402892FB
