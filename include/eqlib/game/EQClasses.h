...
constexpr size_t EQWorldData_size = 0x1F88; // @sizeof(EQWorldData) :: 2025-10-22 (test) @ 0x1402633E6
...
constexpr size_t SkillManager_size = 0x376A00; // @sizeof(SkillManager) :: 2025-10-22 (test) @ 0x140263526
