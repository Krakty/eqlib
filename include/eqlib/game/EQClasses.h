...
constexpr size_t EQWorldData_size = 0x1F88; // @sizeof(EQWorldData) :: 2025-11-19 (test) @ 0x1402660D0
...
constexpr size_t SkillManager_size = 0x399C80; // @sizeof(SkillManager) :: 2025-11-19 (test) @ 0x140266210
