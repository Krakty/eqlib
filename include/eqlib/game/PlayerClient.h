...
/*0x01d0*/ unsigned int             Meditating;
/*0x01d4*/ unsigned int             LastRefresh;
/*0x01d8*/ void*                    pRaceGenderInfo;
/*0x01e0*/ int                      PetID;
/*0x01e4*/ unsigned int             StunTimer;
/*0x01e8*/ uint8_t                  IntimidateCount;
/*0x01ec*/ unsigned int             Zone;
/*0x01f0*/ int                      DoSpecialMelee;
/*0x01f8*/ int64_t                  GuildID;
/*0x0200*/ unsigned int             ACounter;
/*0x0204*/ float                    AnimationSpeedRelated;
/*0x0208*/ int                      ManaCurrent;
/*0x020c*/ int                      IsAttacking;
/*0x0210*/ uint8_t                  GMRank;
/*0x0214*/ int                      Anon;
/*0x0218*/ CPhysicsInfo             LastCollision;
/*0x0248*/ float                    FallingStartZ;
/*0x024c*/ uint8_t                  StandState;
/*0x024d*/ bool                     bStationary;
/*0x024e*/ char                     Title[0x80];
/*0x02d0*/ CharacterZoneClient*     pCharacter;
/*0x02d8*/ int64_t                  HPMax;
/*0x02e0*/ int                      RealEstateID;
/*0x02e4*/ int                      Buyer;
/*0x02e8*/ int                      Deity;
/*0x02f0*/ SPAWNINFO*               pViewPlayer;
/*0x02f8*/ int                      ManaMax;
/*0x02fc*/ int                      PrimaryTintIndex;
/*0x0300*/ uint8_t                  Light;
/*0x0301*/ uint8_t                  FishingEvent;
/*0x0304*/ unsigned int             NextIntimidateTime;
/*0x0308*/ char                     DraggingPlayer[0x40];
/*0x0348*/ unsigned int             LastTick;
/*0x034c*/ uint8_t                  Blind;
/*0x034d*/ bool                     bBetaBuffed;
/*0x034e*/ bool                     Sneak;
/*0x034f*/ uint8_t                  TitleVisible;
/*0x0350*/ bool                     bSummoned;
/*0x0351*/ bool                     Linkdead;
/*0x0354*/ unsigned int             SitStartTime;
/*0x0358*/ int                      SecondaryTintIndex;
/*0x035c*/ unsigned int             RespawnTimer;
/*0x0360*/ char                     DragNames[2][0x40];
/*0x03e0*/ int                      berserker;
/*0x03e4*/ int                      WarCry;
/*0x03e8*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x03f0*/ int                      Unknown1;
/*0x03f4*/ unsigned int             TimeStamp;
/*0x03f8*/ char                     Suffix[0x80];
/*0x0478*/ char                     GM;
/*0x047c*/ float                    RunSpeed;
/*0x0480*/ EqItemGuid               realEstateItemGuid;
/*0x0494*/ unsigned int             LastTimeStoodStill;
/*0x0498*/ int                      SomeData[2];
/*0x04a0*/ float                    MyWalkSpeed;
/*0x04a4*/ uint8_t                  Level;
/*0x04a8*/ unsigned int             LastResendAddPlayerPacket;
/*0x04ac*/ unsigned int             LoginSerial;
/*0x04b0*/ char                     LoginRelated[0x20];
/*0x04d0*/ unsigned int             FishingETA;
/*0x04d4*/ bool                     PvPFlag;
/*0x04d8*/ int                      Trader;
/*0x04dc*/ int                      CurrIOState;
/*0x04e0*/ unsigned int**           ppUDP;
/*0x04e8*/ bool                     bBuffTimersOnHold;
/*0x04ec*/ int                      HideMode;
/*0x04f0*/ unsigned int             SpellGemETA[15];
/*0x052c*/ bool                     LFG;
/*0x0530*/ int                      NpcTintIndex;
/*0x0534*/ float                    MerchantGreed;
/*0x0538*/ unsigned int             NextSwim;
/*0x053c*/ unsigned int             LastSecondaryUseTime;
/*0x0540*/ unsigned int             LastTrapDamageTime;
/*0x0548*/ void*                    pTouchingSwitch;
/*0x0550*/ LaunchSpellData          CastingData;
/*0x0594*/ unsigned int             LastRangedUsedTime;
/*0x0598*/ bool                     bSwitchMoved;
/*0x0599*/ uint8_t                  FindBits;
/*0x059a*/ uint8_t                  FD;
/*0x059b*/ uint8_t                  Original;
/*0x05a0*/ int64_t                  HPCurrent;
/*0x05a8*/ int                      Unknown4;
/*0x05ac*/ float                    GetMeleeRangeVar1;
/*0x05b0*/ int                      AltAttack;
/*0x05b4*/ int                      RealEstateItemId;
/*0x05b8*/ bool                     Mercenary;
/*0x05bc*/ int                      Birthdate;
/*0x05c0*/ char                     Handle[0x20];
/*0x05e0*/ float                    CameraOffset;
/*0x05e4*/ int                      Unknown3;
/*0x05e8*/ unsigned int             LastMealTime;
/*0x05ec*/ bool                     bAlwaysShowAura;
/*0x05ed*/ uint8_t                  InPvPArea;
/*0x05f0*/ int                      AFK;
/*0x05f4*/ bool                     bOfflineMode;
/*0x05f5*/ bool                     bAttackRelated;
/*0x05f6*/ uint8_t                  CharClass;
/*0x05f8*/ unsigned int             MasterID;
/*0x05fc*/ float                    ViewHeight;
/*0x0600*/ unsigned int             EnduranceMax;
/*0x0604*/ unsigned int             LastPrimaryUseTime;
/*0x0608*/ unsigned int             MinuteTimer;
/*0x060c*/ uint8_t                  IsPassenger;
/*0x0610*/ int                      EnduranceCurrent;
/*0x0614*/ float                    MissileRangeToTarget;
/*0x0618*/ bool                     bAnimationOnPop;
/*0x061c*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0624*/ bool                     bTempPet;
/*0x0625*/ bool                     bShowHelm;
/*0x0628*/ float                    BearingToTarget;
/*0x062c*/ uint8_t                  HoldingAnimation;
...
constexpr size_t PlayerClient_size = 0x20B0; // @sizeof(PlayerClient) :: 2025-11-24 (test) @ 0x1402FE8CE
