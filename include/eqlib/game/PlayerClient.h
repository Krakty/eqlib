...
/*0x0484*/ int                      Anon;
/*0x0488*/ unsigned int             Meditating;
/*0x048c*/ unsigned int             NextIntimidateTime;
/*0x0490*/ int64_t                  HPCurrent;
/*0x0498*/ uint8_t                  GMRank;
/*0x049c*/ unsigned int             LastTrapDamageTime;
/*0x04a0*/ bool                     bSwitchMoved;
/*0x04a1*/ bool                     bSummoned;
/*0x04a2*/ uint8_t                  LastAttack;
/*0x04a8*/ void*                    pRaceGenderInfo;
/*0x04b0*/ unsigned int             TimeStamp;
/*0x04b4*/ int                      WarCry;
/*0x04b8*/ unsigned int             ACounter;
/*0x04bc*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x04c4*/ int                      PrimaryTintIndex;
/*0x04c8*/ uint8_t                  HoldingAnimation;
/*0x04c9*/ bool                     bTempPet;
/*0x04cc*/ float                    MissileRangeToTarget;
/*0x04d0*/ uint8_t                  StandState;
/*0x04d4*/ int                      PetID;
/*0x04d8*/ unsigned int             LastMealTime;
/*0x04dc*/ unsigned int             EnduranceMax;
/*0x04e0*/ unsigned int             MasterID;
/*0x04e4*/ uint8_t                  FindBits;
/*0x04e8*/ int                      IsAttacking;
/*0x04ec*/ CPhysicsInfo             LastCollision;
/*0x051c*/ uint8_t                  Original;
/*0x051d*/ bool                     bBuffTimersOnHold;
/*0x0520*/ int                      Unknown3;
/*0x0524*/ char                     Title[0x80];
/*0x05a4*/ int                      DoSpecialMelee;
...
/*0x05b8*/ uint8_t                  Level;
/*0x05c0*/ SPAWNINFO*               pViewPlayer;
/*0x05c8*/ uint8_t                  Blind;
/*0x05cc*/ float                    ViewHeight;
/*0x05d0*/ bool                     bAlwaysShowAura;
/*0x05d1*/ bool                     bShowHelm;
/*0x05d4*/ int                      CurrIOState;
...
/*0x0600*/ float                    RunSpeed;
/*0x0604*/ int                      ManaCurrent;
/*0x0608*/ bool                     PvPFlag;
/*0x060c*/ unsigned int             SpellGemETA[15];
/*0x0648*/ bool                     bBetaBuffed;
...
constexpr size_t PlayerClient_size = 0x20C0; // @sizeof(PlayerClient) :: 2026-01-22 (live) @ 0x140301ABE
