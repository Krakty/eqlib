...
/*0x1cc*/ unsigned int             MinuteTimer;
/*0x1d0*/ int                      Birthdate;
/*0x1d4*/ float                    CameraOffset;
/*0x1d8*/ unsigned int             Meditating;
/*0x1dc*/ int                      Unknown0x394;
/*0x1e0*/ int64_t                  HPCurrent;
/*0x1e8*/ int                      Unknown0x1e8;
/*0x1ec*/ int                      CurrIOState;
/*0x1f0*/ int                      Unknown0x1f0;
/*0x1f4*/ int                      WarCry;
/*0x1f8*/ float                    BearingToTarget;
/*0x1fc*/ unsigned int             LastPrimaryUseTime;
/*0x200*/ float                    MerchantGreed;
/*0x204*/ int                      IsAttacking;
/*0x208*/ int                      PrimaryTintIndex;
/*0x20c*/ int                      FamiliarID;
/*0x210*/ unsigned int             LastTick;
/*0x214*/ unsigned int             EnduranceMax;
/*0x218*/ int                      SecondaryTintIndex;
/*0x21c*/ unsigned int             LastTrapDamageTime;
/*0x220*/ int                      Unknown0x220;
/*0x224*/ bool                     PvPFlag;
/*0x225*/ bool                     Unknown0x284;
/*0x226*/ uint8_t                  HoldingAnimation;
/*0x227*/ bool                     IntimidateState;
/*0x228*/ void*                    pRaceGenderInfo;
/*0x230*/ uint8_t                  Unknown0x230;
/*0x231*/ uint8_t                  Blind;
/*0x232*/ uint8_t                  Unknown0x232[6];
/*0x238*/ int64_t                  HPMax;
/*0x240*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x248*/ uint8_t                  StandState;
/*0x249*/ uint8_t                  Unknown0x249;
/*0x24a*/ uint8_t                  _pad_24a[0x2];
...
/*0x2b8*/ int                      Anon;                   // Anonymous==1, Roleplay==2
/*0x2bc*/ char                     Unknown0x2bc[0xc];
/*0x2c8*/ int                      EnduranceCurrent;
/*0x2cc*/ char                     Unknown0x2cc[0x5c];
/*0x328*/ char                     Handle[0x20];
/*0x348*/ uint8_t                  FishingEvent;
/*0x349*/ bool                     bBetaBuffed;
/*0x34a*/ bool                     bAnimationOnPop;
/*0x34b*/ bool                     bOfflineMode;
/*0x34c*/ int                      Deity;
/*0x350*/ unsigned int             Unknown0x350;
/*0x354*/ int                      Unknown0x354;
/*0x358*/ int                      Unknown0x340;
/*0x35c*/ EqItemGuid               realEstateItemGuid;
...
/*0x3f3*/ bool                     bBuffTimersOnHold;
/*0x3f4*/ bool                     bShowHelm;
/*0x3f5*/ uint8_t                  Unknown0x3f5;
/*0x3f6*/ uint8_t                  IntimidateCount;
/*0x3f7*/ uint8_t                  Unknown0x3f7;
...
/*0x441*/ bool                     bSwitchMoved;
/*0x442*/ bool                     bStationary;
/*0x443*/ uint8_t                  LastAttack;
/*0x444*/ bool                     berserker;
/*0x445*/ uint8_t                  Original;
/*0x446*/ uint8_t  _pad_446[0xa];
/*0x450*/ int                      AFK;
/*0x454*/ unsigned int             RespawnTimer;           // 0 while alive, nonzero on hover/death; drives ${Me.State}==HOVER
/*0x458*/ char                     Unknown0x458[0x8];
/*0x460*/ int                      ManaCurrent;
/*0x464*/ char                     Unknown0x464[0x8];
/*0x46c*/ unsigned int             NextSwim;
/*0x470*/ char                     Unknown0x470[0x1];
/*0x471*/ char                     Suffix[0x63];
/*0x4d4*/ char                     LoginRelated[0x20];
/*0x4f4*/ bool                     bTempPet;
/*0x4f5*/ uint8_t                  AltAttack;
...
/*0x5fc*/ int                      ManaMax;
/*0x600*/ int                      HideMode;               // MQ Spawn.Invis = HideMode != 0
/*0x604*/ unsigned int             FishingETA;
...
/*0x64c*/ int                      Unknown0x590;
/*0x650*/ int                      Unknown0x594;
/*0x654*/ unsigned int             Zone;
/*0x658*/ unsigned int             NextIntimidateTime;
/*0x65c*/ float                    MissileRangeToTarget;
...
/*0x0fac*/ unsigned int             Unknown0x0fac;
/*0x0fb0*/ unsigned int             Unknown0x0fb0;
...
/*0x120c*/ float                    CachedCeilingLocationZ;
/*0x1210*/ float                    CachedCeilingHeight;
/*0x1214*/ CCapsule                 StaticCollision;
/*0x1230*/ float                    CachedFloorLocationY;
/*0x1234*/ float                    CachedFloorLocationX;
/*0x1238*/ float                    CachedFloorLocationZ;
/*0x123c*/ float                    CachedFloorHeight;
...
constexpr size_t PlayerClient_size = 0x20B8; // @sizeof(PlayerClient) :: 2026-06-24 (test) -0x20 tail surgery (otto_011/020)
...
// ---- 6/24 tail surgery (PlayerClient -0x20: 0x20D8 -> 0x20B8); CopyCtor-witnessed (otto_020) ----
//   6/24 REMOVED: SpawnStatus[1..5] (-0x14), BannerIndex0/BannerIndex1 (-0x8), MountAnimationRelated (-0x4)
//   surviving fields below shift down accordingly; base of SpawnStatus stays at 0x20a8.
/*0x20a8*/ int               SpawnStatus[1];               // 6/24: shrunk from [6]
/*0x20ac*/ ARGBCOLOR         BannerTint0;                  // guild banners; 6/9 0x20c8 -> -0x1c
/*0x20b0*/ ARGBCOLOR         BannerTint1;                  // 6/9 0x20cc -> -0x1c
/*0x20b4*/ bool              bGuildShowAnim;               // 6/9 0x20d4 -> -0x20
/*0x20b5*/ bool              bWaitingForPort;              // 6/9 0x20d5 -> -0x20
/*0x20b8*/
