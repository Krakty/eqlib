...
/*0x0284*/ unsigned int             SpellCooldownETA;
/*0x0288*/ unsigned int             LastTimeStoodStill;
...
/*0x03c9*/ char                     DragNames[2][0x40];
/*0x044c*/ unsigned int             LastResendAddPlayerPacket;
/*0x0450*/ float                    MyWalkSpeed;
/*0x0454*/ float                    RunSpeed;
...
/*0x04ac*/ uint8_t                  InPvPArea;
/*0x04ad*/ bool                     bSummoned;
/*0x04b0*/ float                    GetMeleeRangeVar1;
/*0x04b4*/ int                      Anon;
/*0x04b8*/ int                      IsAttacking;
/*0x04bc*/ int                      PrimaryTintIndex;
/*0x04c0*/ unsigned int             EnduranceMax;
/*0x04c4*/ int                      WarCry;
/*0x04c8*/ int64_t                  HPMax;
/*0x04d0*/ unsigned int             NextSwim;
/*0x04d4*/ int                      AFK;
/*0x04d8*/ float                    BearingToTarget;
/*0x04dc*/ uint8_t                  GMRank;
/*0x04dd*/ bool                     Linkdead;
/*0x04e0*/ unsigned int             FishingETA;
/*0x04e4*/ uint8_t                  IsPassenger;
/*0x04e8*/ unsigned int             NextIntimidateTime;
/*0x04ec*/ uint8_t                  TitleVisible;
/*0x04ed*/ bool                     bBuffTimersOnHold;
/*0x04f0*/ int                      Unknown4;
/*0x04f4*/ unsigned int             LastTrapDamageTime;
/*0x04f8*/ bool                     bOfflineMode;
/*0x04f9*/ char                     Handle[0x20];
/*0x0519*/ uint8_t                  FishingEvent;
/*0x051a*/ uint8_t                  Original;
/*0x051c*/ float                    FallingStartZ;
/*0x0520*/ int64_t                  HPCurrent;
/*0x0528*/ uint8_t                  Light;
/*0x052c*/ int                      SecondaryTintIndex;
/*0x0530*/ bool                     bSwitchMoved;
/*0x0534*/ unsigned int             LastRefresh;
/*0x0538*/ char                     LoginRelated[0x20];
/*0x0558*/ LaunchSpellData          CastingData;
/*0x059c*/ int                      Unknown3;
/*0x05a0*/ int                      ManaMax;
/*0x05a4*/ int                      RealEstateID;
/*0x05a8*/ int                      RealEstateItemId;
/*0x05ac*/ unsigned int             SitStartTime;
...
/*0x05cc*/ bool                     Sneak;
/*0x05cd*/ uint8_t                  StandState;
/*0x05ce*/ uint8_t                  Level;
/*0x05d0*/ unsigned int             LastRangedUsedTime;
/*0x05d4*/ bool                     bAlwaysShowAura;
/*0x05d8*/ unsigned int             SpellGemETA[15];
/*0x0614*/ unsigned int             TimeStamp;
/*0x0618*/ int                      CurrIOState;
/*0x061c*/ int                      EnduranceCurrent;
/*0x0620*/ unsigned int             CorpseDragCount;
/*0x0624*/ int                      HideMode;
/*0x0628*/ float                    ViewHeight;
/*0x062c*/ uint8_t                  HoldingAnimation;
/*0x0630*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0638*/ unsigned int             LastMealTime;
/*0x063c*/ unsigned int             LastSecondaryUseTime;
/*0x0640*/ bool                     PvPFlag;
...
constexpr size_t PlayerClient_size = 0x20B8; // @sizeof(PlayerClient) :: 2026-03-03 (test) @ 0x140305B9E
