...
/*0x01fc*/ unsigned int             TimeStamp;
/*0x0200*/ int                      HideMode;
/*0x0208*/ unsigned int**           ppUDP;
/*0x0210*/ int                      SomeData[2];
/*0x0218*/ void*                    pRaceGenderInfo;
/*0x0220*/ uint8_t                  FindBits;
/*0x0224*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x022c*/ unsigned int             SpellGemETA[15];
/*0x0268*/ uint8_t                  FishingEvent;
/*0x026c*/ unsigned int             RespawnTimer;
/*0x0270*/ uint8_t                  StandState;
/*0x0271*/ bool                     Sneak;
/*0x0272*/ EqItemGuid               realEstateItemGuid;
/*0x0284*/ bool                     bBetaBuffed;
/*0x0288*/ unsigned int             SitStartTime;
/*0x028c*/ int                      Trader;
/*0x0290*/ unsigned int             LoginSerial;
/*0x0294*/ bool                     bShowHelm;
/*0x0298*/ unsigned int             LastTrapDamageTime;
/*0x029c*/ unsigned int             MinuteTimer;
/*0x02a0*/ unsigned int             LastRefresh;
/*0x02a4*/ bool                     bAttackRelated;
/*0x02a8*/ float                    ViewHeight;
/*0x02ac*/ int                      berserker;
/*0x02b0*/ int                      WarCry;
/*0x02b4*/ unsigned int             StunTimer;
/*0x02b8*/ uint8_t                  GMRank;
/*0x02bc*/ float                    MyWalkSpeed;
/*0x02c0*/ char                     Handle[0x20];
/*0x02e0*/ char                     DraggingPlayer[0x40];
/*0x0320*/ int                      IsAttacking;
/*0x0324*/ uint8_t                  HoldingAnimation;
/*0x0328*/ unsigned int             LastTimeStoodStill;
/*0x032c*/ float                    FallingStartZ;
/*0x0330*/ uint8_t                  FD;
/*0x0334*/ float                    BearingToTarget;
/*0x0338*/ bool                     bAnimationOnPop;
/*0x033c*/ unsigned int             LastTick;
/*0x0340*/ unsigned int             LastRangedUsedTime;
/*0x0344*/ float                    GetMeleeRangeVar1;
/*0x0348*/ int                      ManaCurrent;
/*0x034c*/ unsigned int             SpellCooldownETA;
/*0x0350*/ LaunchSpellData          CastingData;
/*0x0394*/ unsigned int             Meditating;
/*0x0398*/ unsigned int             LastResendAddPlayerPacket;
/*0x039c*/ int                      AFK;
/*0x03a0*/ int                      PrimaryTintIndex;
/*0x03a4*/ int                      RealEstateID;
/*0x03a8*/ uint8_t                  IntimidateCount;
/*0x03a9*/ uint8_t                  Original;
/*0x03aa*/ bool                     bTempPet;
/*0x03ac*/ int                      EnduranceCurrent;
/*0x03b0*/ uint8_t                  TitleVisible;
/*0x03b4*/ unsigned int             NextIntimidateTime;
/*0x03b8*/ uint8_t                  Level;
/*0x03c0*/ int64_t                  HPCurrent;
/*0x03c8*/ int                      Birthdate;
/*0x03cc*/ int                      Unknown3;
/*0x03d0*/ CharacterZoneClient*     pCharacter;
/*0x03d8*/ unsigned int             LastSecondaryUseTime;
/*0x03dc*/ CPhysicsInfo             LastCollision;
/*0x040c*/ int                      CurrIOState;
/*0x0410*/ int64_t                  HPMax;
/*0x0418*/ bool                     bStationary;
/*0x0420*/ SPAWNINFO*               pViewPlayer;
/*0x0428*/ char                     LoginRelated[0x20];
/*0x0448*/ int                      Unknown1;
/*0x044c*/ int                      PetID;
/*0x0450*/ char                     Suffix[0x80];
/*0x04d0*/ char                     Title[0x80];
/*0x0550*/ unsigned int             MasterID;
/*0x0554*/ uint8_t                  Light;
/*0x0555*/ bool                     LFG;
/*0x0558*/ unsigned int             NextSwim;
/*0x055c*/ int                      SecondaryTintIndex;
/*0x0560*/ int                      DoSpecialMelee;
/*0x0564*/ uint8_t                  InPvPArea;
/*0x0568*/ float                    AnimationSpeedRelated;
/*0x056c*/ uint8_t                  IsPassenger;
/*0x0570*/ unsigned int             FishingETA;
/*0x0574*/ unsigned int             LastMealTime;
/*0x0578*/ float                    CameraOffset;
/*0x057c*/ float                    RunSpeed;
...
/*0x059c*/ int                      Buyer;
/*0x05a0*/ bool                     bBuffTimersOnHold;
/*0x05a1*/ bool                     Linkdead;
/*0x05a4*/ unsigned int             CorpseDragCount;
/*0x05a8*/ unsigned int             Zone;
/*0x05ac*/ bool                     bAlwaysShowAura;
/*0x05b0*/ unsigned int             EnduranceMax;
/*0x05b4*/ unsigned int             LastPrimaryUseTime;
/*0x05b8*/ uint8_t                  CharClass;
/*0x05bc*/ int                      ManaMax;
/*0x05c0*/ float                    MerchantGreed;
/*0x05c4*/ unsigned int             ACounter;
/*0x05c8*/ bool                     PvPFlag;
/*0x05c9*/ char                     GM;
/*0x05ca*/ char                     DragNames[2][0x40];
...
constexpr size_t PlayerClient_size = 0x20C0; // @sizeof(PlayerClient) :: 2025-10-13 (live) @ 0x1402FB53E
