...
/*0x0234*/ int                      HideMode;
/*0x0238*/ unsigned int             NextSwim;
/*0x023c*/ unsigned int             CorpseDragCount;
/*0x0240*/ uint8_t                  InPvPArea;
/*0x0241*/ char                     LoginRelated[0x20];
/*0x0264*/ unsigned int             StunTimer;
/*0x0268*/ int                      Deity;
/*0x026c*/ int                      AFK;
/*0x0270*/ int                      NpcTintIndex;
/*0x0278*/ SPAWNINFO*               pViewPlayer;
/*0x0280*/ float                    RunSpeed;
/*0x0284*/ int                      AltAttack;
/*0x0288*/ int                      EnduranceCurrent;
/*0x028c*/ CPhysicsInfo             LastCollision;
/*0x02bc*/ unsigned int             SpellGemETA[15];
/*0x02f8*/ unsigned int             SpellCooldownETA;
/*0x02fc*/ int                      IsAttacking;
/*0x0300*/ float                    ViewHeight;
/*0x0304*/ unsigned int             LoginSerial;
/*0x0308*/ uint8_t                  Light;
/*0x0309*/ bool                     bBetaBuffed;
/*0x030c*/ unsigned int             LastTrapDamageTime;
/*0x0310*/ unsigned int             MasterID;
/*0x0314*/ bool                     bStationary;
/*0x0315*/ uint8_t                  TitleVisible;
/*0x0318*/ int                      SomeData[2];
/*0x0320*/ void*                    pTouchingSwitch;
/*0x0328*/ uint8_t                  CharClass;
/*0x0329*/ bool                     Linkdead;
/*0x032c*/ unsigned int             SitStartTime;
...
/*0x0345*/ char                     Suffix[0x80];
/*0x03c8*/ unsigned int             EnduranceMax;
/*0x03d0*/ int64_t                  GuildID;
/*0x03d8*/ char                     DraggingPlayer[0x40];
/*0x0418*/ unsigned int             Meditating;
/*0x041c*/ char                     Title[0x80];
/*0x04a0*/ unsigned int**           ppUDP;
/*0x04a8*/ uint8_t                  Original;
/*0x04a9*/ bool                     Sneak;
/*0x04aa*/ uint8_t                  FD;
/*0x04ac*/ int                      berserker;
/*0x04b0*/ bool                     bSummoned;
/*0x04b1*/ uint8_t                  Level;
/*0x04b8*/ int64_t                  HPCurrent;
/*0x04c0*/ char                     Handle[0x20];
/*0x04e0*/ bool                     bBuffTimersOnHold;
/*0x04e1*/ bool                     LFG;
/*0x04e2*/ uint8_t                  Blind;
/*0x04e4*/ int                      ManaMax;
/*0x04e8*/ int                      RealEstateID;
/*0x04ec*/ int                      Birthdate;
/*0x04f0*/ uint8_t                  FishingEvent;
/*0x04f4*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x04fc*/ int                      WarCry;
/*0x0500*/ int                      Unknown1;
/*0x0504*/ int                      Trader;
/*0x0508*/ unsigned int             ACounter;
/*0x050c*/ float                    GetMeleeRangeVar1;
/*0x0510*/ bool                     bSwitchMoved;
/*0x0511*/ bool                     Mercenary;
/*0x0512*/ uint8_t                  IntimidateCount;
/*0x0514*/ int                      Unknown3;
/*0x0518*/ unsigned int             LastSecondaryUseTime;
/*0x051c*/ bool                     bShowHelm;
/*0x051d*/ uint8_t                  HoldingAnimation;
/*0x051e*/ char                     DragNames[2][0x40];
/*0x05a0*/ int64_t                  HPMax;
/*0x05a8*/ bool                     bTempPet;
/*0x05a9*/ bool                     bAlwaysShowAura;
/*0x05aa*/ uint8_t                  FindBits;
...
/*0x05bc*/ float                    AnimationSpeedRelated;
/*0x05c0*/ unsigned int             MinuteTimer;
/*0x05c4*/ unsigned int             FishingETA;
/*0x05c8*/ int                      Buyer;
/*0x05cc*/ int                      Anon;
/*0x05d0*/ unsigned int             NextIntimidateTime;
/*0x05d4*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x05dc*/ unsigned int             LastPrimaryUseTime;
/*0x05e0*/ int                      ManaCurrent;
/*0x05e4*/ float                    BearingToTarget;
/*0x05e8*/ EqItemGuid               realEstateItemGuid;
/*0x05fa*/ char                     GM;
/*0x0600*/ void*                    pRaceGenderInfo;
/*0x0608*/ float                    CameraOffset;
/*0x060c*/ bool                     PvPFlag;
/*0x060d*/ uint8_t                  IsPassenger;
/*0x0610*/ unsigned int             TimeStamp;
/*0x0614*/ uint8_t                  StandState;
/*0x0615*/ bool                     bAnimationOnPop;
/*0x0618*/ int                      CurrIOState;
/*0x061c*/ float                    FallingStartZ;
/*0x0620*/ unsigned int             LastMealTime;
...
constexpr size_t PlayerClient_size = 0x20B0; // @sizeof(PlayerClient) :: 2025-11-03 (test) @ 0x1402FE93E
