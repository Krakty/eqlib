...
/*0x01e4*/ uint8_t                  GMRank;
/*0x01e8*/ int                      Buyer;
/*0x01ec*/ int                      RealEstateItemId;
/*0x01f0*/ bool                     bAttackRelated;
/*0x01f4*/ unsigned int             NextIntimidateTime;
/*0x01f8*/ void*                    pRaceGenderInfo;
/*0x0200*/ unsigned int             MasterID;
/*0x0204*/ uint8_t                  StandState;
/*0x0208*/ unsigned int             TimeStamp;
/*0x020c*/ int                      Unknown1;
/*0x0210*/ bool                     bStationary;
/*0x0211*/ bool                     bSwitchMoved;
/*0x0212*/ bool                     bBetaBuffed;
/*0x0213*/ char                     Handle[0x20];
/*0x0234*/ unsigned int             LastRangedUsedTime;
/*0x0238*/ uint8_t                  FishingEvent;
/*0x023c*/ int                      SecondaryTintIndex;
/*0x0240*/ uint8_t                  LastAttack;
/*0x0241*/ uint8_t                  Light;
/*0x0248*/ void*                    pTouchingSwitch;
/*0x0250*/ char                     GM;
/*0x0254*/ unsigned int             SpellGemETA[15];
/*0x0290*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0298*/ bool                     Linkdead;
/*0x029c*/ unsigned int             LastTimeStoodStill;
/*0x02a0*/ bool                     PvPFlag;
/*0x02a8*/ CharacterZoneClient*     pCharacter;
/*0x02b0*/ unsigned int             SitStartTime;
...
/*0x02c4*/ int                      Unknown4;
/*0x02c8*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x02d0*/ unsigned int             LastResendAddPlayerPacket;
/*0x02d4*/ unsigned int             MinuteTimer;
/*0x02d8*/ float                    MyWalkSpeed;
/*0x02dc*/ unsigned int             LastSecondaryUseTime;
/*0x02e0*/ CPhysicsInfo             LastCollision;
/*0x0310*/ LaunchSpellData          CastingData;
/*0x0354*/ unsigned int             LastTick;
/*0x0358*/ unsigned int             Zone;
/*0x035c*/ char                     DragNames[2][0x40];
/*0x03dc*/ uint8_t                  TitleVisible;
/*0x03e0*/ int                      PetID;
/*0x03e4*/ unsigned int             LastPrimaryUseTime;
/*0x03e8*/ char                     LoginRelated[0x20];
/*0x0408*/ int                      AltAttack;
/*0x040c*/ uint8_t                  FindBits;
/*0x0410*/ float                    GetMeleeRangeVar1;
/*0x0414*/ uint8_t                  Original;
/*0x0415*/ bool                     LFG;
...
/*0x0434*/ uint8_t                  Blind;
/*0x0435*/ uint8_t                  FD;
/*0x0438*/ unsigned int             SpellCooldownETA;
/*0x043c*/ unsigned int             LastTrapDamageTime;
/*0x0440*/ int                      Birthdate;
/*0x0444*/ char                     DraggingPlayer[0x40];
/*0x0484*/ int                      NpcTintIndex;
/*0x0488*/ bool                     bAlwaysShowAura;
/*0x0489*/ uint8_t                  HoldingAnimation;
/*0x048c*/ unsigned int             CorpseDragCount;
/*0x0490*/ float                    RunSpeed;
/*0x0494*/ int                      DoSpecialMelee;
/*0x0498*/ SPAWNINFO*               pViewPlayer;
/*0x04a0*/ int                      Trader;
/*0x04a4*/ int                      HideMode;
/*0x04a8*/ int                      Anon;
/*0x04ac*/ int                      SomeData[2];
/*0x04b4*/ int                      RealEstateID;
/*0x04b8*/ bool                     bOfflineMode;
/*0x04bc*/ int                      AFK;
/*0x04c0*/ EqItemGuid               realEstateItemGuid;
/*0x04d2*/ char                     Title[0x80];
/*0x0554*/ float                    MerchantGreed;
/*0x0558*/ unsigned int             NextSwim;
/*0x055c*/ unsigned int             RespawnTimer;
/*0x0560*/ bool                     bSummoned;
/*0x0564*/ int                      CurrIOState;
/*0x0568*/ int                      ManaMax;
/*0x056c*/ uint8_t                  IsPassenger;
/*0x056d*/ bool                     bBuffTimersOnHold;
/*0x056e*/ char                     Suffix[0x80];
/*0x05ee*/ bool                     bTempPet;
/*0x05ef*/ uint8_t                  IntimidateCount;
/*0x05f0*/ bool                     bAnimationOnPop;
/*0x05f4*/ unsigned int             LoginSerial;
/*0x05f8*/ int                      Deity;
/*0x05fc*/ int                      WarCry;
/*0x0600*/ int                      EnduranceCurrent;
/*0x0604*/ unsigned int             StunTimer;
...
/*0x0620*/ uint8_t                  CharClass;
/*0x0624*/ int                      IsAttacking;
/*0x0628*/ unsigned int             LastRefresh;
/*0x062c*/ bool                     Sneak;
/*0x0630*/ float                    FallingStartZ;
/*0x0634*/ unsigned int             EnduranceMax;
/*0x0638*/ int64_t                  HPCurrent;
...
constexpr size_t PlayerClient_size = 0x20C0; // @sizeof(PlayerClient) :: 2025-11-19 (test) @ 0x1402FE3DE
