...
/*0x01cc*/ uint8_t                  CharClass;
/*0x01d0*/ unsigned int             FishingETA;
...
/*0x0225*/ char                     Title[0x80];
/*0x02a8*/ unsigned int             LastRefresh;
/*0x02ac*/ bool                     bAttackRelated;
/*0x02ad*/ char                     DraggingPlayer[0x40];
/*0x02f0*/ unsigned int             RespawnTimer;
/*0x02f4*/ bool                     bAnimationOnPop;
/*0x02f8*/ CharacterZoneClient*     pCharacter;
/*0x0300*/ bool                     Linkdead;
/*0x0301*/ char                     DragNames[2][0x40];
/*0x0384*/ unsigned int             EnduranceMax;
/*0x0388*/ int                      HideMode;
/*0x038c*/ char                     LoginRelated[0x20];
/*0x03ac*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x03b4*/ int                      SecondaryTintIndex;
/*0x03b8*/ float                    BearingToTarget;
/*0x03bc*/ bool                     bSwitchMoved;
/*0x03bd*/ uint8_t                  IntimidateCount;
/*0x03c0*/ float                    MissileRangeToTarget;
/*0x03c4*/ unsigned int             ACounter;
/*0x03c8*/ unsigned int             LastResendAddPlayerPacket;
/*0x03cc*/ int                      WarCry;
/*0x03d0*/ int                      Unknown4;
/*0x03d4*/ unsigned int             Meditating;
/*0x03d8*/ unsigned int             LastSecondaryUseTime;
/*0x03dc*/ bool                     bBetaBuffed;
/*0x03dd*/ bool                     PvPFlag;
/*0x03e0*/ unsigned int             NextIntimidateTime;
/*0x03e8*/ int64_t                  HPMax;
/*0x03f0*/ unsigned int             LastPrimaryUseTime;
/*0x03f4*/ float                    ViewHeight;
/*0x03f8*/ int                      SomeData[2];
/*0x0400*/ float                    RunSpeed;
/*0x0404*/ int                      RealEstateID;
/*0x0408*/ float                    AnimationSpeedRelated;
/*0x040c*/ int                      PetID;
/*0x0410*/ uint8_t                  StandState;
/*0x0414*/ unsigned int             NextSwim;
/*0x0418*/ int                      Anon;
/*0x041c*/ bool                     bSummoned;
/*0x0420*/ int                      Trader;
/*0x0424*/ EqItemGuid               realEstateItemGuid;
/*0x0438*/ int                      Birthdate;
/*0x043c*/ int                      ManaCurrent;
/*0x0440*/ int                      Buyer;
/*0x0444*/ uint8_t                  FishingEvent;
/*0x0448*/ float                    CameraOffset;
/*0x044c*/ bool                     bShowHelm;
/*0x0450*/ unsigned int             MinuteTimer;
/*0x0454*/ int                      RealEstateItemId;
/*0x0458*/ bool                     bStationary;
/*0x0460*/ int64_t                  GuildID;
/*0x0468*/ int                      Unknown3;
/*0x046c*/ bool                     bBuffTimersOnHold;
/*0x046d*/ uint8_t                  TitleVisible;
/*0x046e*/ bool                     Mercenary;
/*0x0470*/ unsigned int             SpellGemETA[15];
/*0x04ac*/ int                      Deity;
/*0x04b0*/ float                    MerchantGreed;
/*0x04b4*/ int                      PrimaryTintIndex;
/*0x04b8*/ unsigned int             CorpseDragCount;
/*0x04bc*/ int                      CurrIOState;
/*0x04c0*/ char                     GM;
/*0x04c8*/ unsigned int**           ppUDP;
/*0x04d0*/ int                      berserker;
/*0x04d4*/ float                    GetMeleeRangeVar1;
/*0x04d8*/ int                      DoSpecialMelee;
/*0x04dc*/ unsigned int             StunTimer;
/*0x04e0*/ unsigned int             LoginSerial;
/*0x04e4*/ float                    FallingStartZ;
/*0x04e8*/ uint8_t                  GMRank;
/*0x04e9*/ uint8_t                  FD;
/*0x04ec*/ int                      Unknown1;
/*0x04f0*/ unsigned int             SpellCooldownETA;
/*0x04f4*/ bool                     bAlwaysShowAura;
/*0x04f8*/ unsigned int             LastTimeStoodStill;
/*0x04fc*/ CPhysicsInfo             LastCollision;
/*0x052c*/ bool                     bTempPet;
/*0x052d*/ char                     Suffix[0x80];
/*0x05b0*/ void*                    pRaceGenderInfo;
/*0x05b8*/ bool                     LFG;
/*0x05bc*/ unsigned int             Zone;
/*0x05c0*/ int                      AFK;
/*0x05c4*/ uint8_t                  Level;
/*0x05c8*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x05d0*/ void*                    pTouchingSwitch;
/*0x05d8*/ uint8_t                  IsPassenger;
/*0x05d9*/ uint8_t                  FindBits;
/*0x05da*/ bool                     bOfflineMode;
/*0x05dc*/ unsigned int             TimeStamp;
/*0x05e0*/ uint8_t                  InPvPArea;
/*0x05e8*/ SPAWNINFO*               pViewPlayer;
/*0x05f0*/ bool                     Sneak;
/*0x05f4*/ unsigned int             SitStartTime;
/*0x05f8*/ int                      ManaMax;
/*0x05fc*/ uint8_t                  Blind;
/*0x05fd*/ uint8_t                  HoldingAnimation;
/*0x05fe*/ uint8_t                  LastAttack;
/*0x0600*/ int64_t                  HPCurrent;
/*0x0608*/ unsigned int             MasterID;
/*0x060c*/ uint8_t                  Original;
/*0x0610*/ float                    MyWalkSpeed;
/*0x0614*/ int                      NpcTintIndex;
/*0x0618*/ unsigned int             LastTick;
/*0x061c*/ unsigned int             LastMealTime;
/*0x0620*/ unsigned int             LastRangedUsedTime;
/*0x0624*/ int                      IsAttacking;
/*0x0628*/ char                     Handle[0x20];
...
constexpr size_t PlayerClient_size = 0x20C0; // @sizeof(PlayerClient) :: 2025-10-22 (test) @ 0x1402FB6AE
