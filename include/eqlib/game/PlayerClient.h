...
/*0x01fc*/ char                     GM;
/*0x01fd*/ bool                     LFG;
/*0x01fe*/ bool                     bStationary;
/*0x01ff*/ bool                     Mercenary;
/*0x0200*/ float                    MissileRangeToTarget;
/*0x0204*/ bool                     bAlwaysShowAura;
/*0x0205*/ char                     Suffix[0x80];
/*0x0285*/ bool                     bTempPet;
/*0x0286*/ bool                     Linkdead;
/*0x0288*/ void*                    pRaceGenderInfo;
/*0x0290*/ int                      Unknown3;
/*0x0294*/ char                     LoginRelated[0x20];
/*0x02b4*/ int                      Unknown4;
...
/*0x0310*/ bool                     bAnimationOnPop;
/*0x0314*/ unsigned int             LastSecondaryUseTime;
/*0x0318*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0320*/ EqItemGuid               realEstateItemGuid;
/*0x0334*/ unsigned int             FishingETA;
/*0x0338*/ int                      ManaMax;
/*0x033c*/ float                    MerchantGreed;
/*0x0340*/ unsigned int             NextSwim;
/*0x0344*/ int                      RealEstateID;
...
/*0x03e0*/ int                      WarCry;
/*0x03e4*/ uint8_t                  StandState;
/*0x03e8*/ void*                    pTouchingSwitch;
/*0x03f0*/ unsigned int             TimeStamp;
/*0x03f4*/ bool                     Sneak;
/*0x03f8*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0400*/ uint8_t                  GMRank;
/*0x0401*/ uint8_t                  HoldingAnimation;
/*0x0408*/ int64_t                  HPCurrent;
/*0x0410*/ int                      PrimaryTintIndex;
/*0x0414*/ bool                     bBuffTimersOnHold;
/*0x0418*/ unsigned int             RespawnTimer;
/*0x041c*/ unsigned int             Zone;
/*0x0420*/ unsigned int             LastRangedUsedTime;
/*0x0424*/ bool                     bAttackRelated;
/*0x0428*/ int                      RealEstateItemId;
/*0x042c*/ float                    MyWalkSpeed;
/*0x0430*/ unsigned int             SitStartTime;
/*0x0434*/ int                      Trader;
/*0x0438*/ uint8_t                  LastAttack;
/*0x043c*/ unsigned int             LastTimeStoodStill;
/*0x0440*/ uint8_t                  Blind;
/*0x0444*/ unsigned int             MinuteTimer;
/*0x0448*/ int                      Buyer;
/*0x044c*/ uint8_t                  FishingEvent;
/*0x044d*/ char                     DragNames[2][0x40];
/*0x04d0*/ int                      Anon;
/*0x04d8*/ int64_t                  HPMax;
/*0x04e0*/ int                      DoSpecialMelee;
/*0x04e4*/ uint8_t                  TitleVisible;
/*0x04e5*/ uint8_t                  InPvPArea;
/*0x04e6*/ bool                     bSummoned;
/*0x04e8*/ unsigned int             SpellCooldownETA;
/*0x04ec*/ bool                     bBetaBuffed;
/*0x04f0*/ int                      Birthdate;
/*0x04f4*/ unsigned int             SpellGemETA[15];
/*0x0530*/ unsigned int             MasterID;
/*0x0534*/ float                    AnimationSpeedRelated;
/*0x0538*/ bool                     bSwitchMoved;
/*0x053c*/ float                    CameraOffset;
/*0x0540*/ unsigned int             LastPrimaryUseTime;
/*0x0544*/ float                    GetMeleeRangeVar1;
/*0x0548*/ float                    RunSpeed;
/*0x054c*/ float                    ViewHeight;
/*0x0550*/ unsigned int             LastTrapDamageTime;
/*0x0554*/ bool                     PvPFlag;
/*0x0555*/ bool                     bShowHelm;
/*0x0556*/ uint8_t                  Light;
/*0x0558*/ int                      CurrIOState;
/*0x055c*/ uint8_t                  Original;
/*0x0560*/ int                      Unknown1;
/*0x0564*/ uint8_t                  FD;
/*0x0565*/ uint8_t                  CharClass;
/*0x0566*/ uint8_t                  IsPassenger;
/*0x0568*/ int                      SecondaryTintIndex;
/*0x056c*/ int                      Deity;
/*0x0570*/ int                      IsAttacking;
/*0x0574*/ int                      AltAttack;
/*0x0578*/ int                      SomeData[2];
/*0x0580*/ int                      berserker;
/*0x0588*/ SPAWNINFO*               pViewPlayer;
/*0x0590*/ unsigned int             LoginSerial;
/*0x0594*/ bool                     bOfflineMode;
/*0x0598*/ unsigned int             CorpseDragCount;
/*0x059c*/ LaunchSpellData          CastingData;
...
/*0x05f4*/ unsigned int             LastMealTime;
/*0x05f8*/ char                     Handle[0x20];
/*0x0618*/ unsigned int             LastResendAddPlayerPacket;
/*0x061c*/ uint8_t                  IntimidateCount;
/*0x061d*/ uint8_t                  Level;
/*0x0620*/ int                      NpcTintIndex;
/*0x0624*/ float                    FallingStartZ;
...
constexpr size_t PlayerClient_size = 0x20B0; // @sizeof(PlayerClient) :: 2026-01-27 (test) @ 0x140301CBE
