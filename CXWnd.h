...
constexpr size_t CXWnd_size = 0x270; // @sizeof(CXWnd) :: 2025-01-21 (test) @ 0x1405C6E41
...
/*0x070*/ bool               bEnableShowBorder;
/*0x071*/ uint8_t            Alpha;
/*0x072*/ bool               bShowClickThroughMenuItem;
/*0x073*/ bool               bShowBorder;
/*0x074*/ bool               bNeedsSaving;
/*0x075*/ bool               Minimized;
/*0x076*/ bool               bClipToParent;
/*0x077*/ bool               bKeepOnScreen;
/*0x078*/ uint32_t           XMLIndex;
/*0x080*/ CStaticTintedBlendAnimationTemplate* TitlePiece;
/*0x088*/ int                HScrollMax;
/*0x08c*/ int                BlinkStartTimer;
/*0x090*/ int                HScrollPos;
/*0x098*/ CTextObjectInterface* pTipTextObject;
/*0x0a0*/ uint32_t           LastTimeMouseOver;
/*0x0a4*/ bool               bMaximizable;
/*0x0a8*/ ControllerBase*    pController;
/*0x0b0*/ bool               Enabled;
/*0x0b1*/ bool               bIsTransitioning;
/*0x0b4*/ CXRect             IconRect;
/*0x0c4*/ uint32_t           TransitionDuration;
/*0x0c8*/ bool               bTiled;
...
/*0x0e0*/ int64_t            Data;
/*0x0e8*/ bool               bFullyScreenClipped;
/*0x0f0*/ CXStr              DataStr;
/*0x0f8*/ uint32_t           BlinkFadeFreq;
/*0x0fc*/ bool               Fades;
/*0x100*/ CXStr              WindowText;
/*0x108*/ bool               bLeftAnchoredToLeft;
/*0x10c*/ uint32_t           FadeDuration;
/*0x110*/ int                Transition;
/*0x114*/ bool               bCaptureTitle;
/*0x115*/ uint8_t            bResizableMask;
/*0x116*/ bool               bBringToTopWhenClicked;
/*0x117*/ bool               bMarkedForDelete;
/*0x118*/ int                BlinkDuration;
/*0x11c*/ bool               Unlockable;
/*0x120*/ uint32_t           TransitionStartTick;
/*0x124*/ bool               bBottomAnchoredToTop;
/*0x125*/ bool               bIsParentOrContextMenuWindow;
/*0x126*/ uint8_t            FadeToAlpha;
/*0x127*/ bool               bClientRectChanged;
/*0x128*/ CXRect             ClipRectScreen;
/*0x138*/ int                BottomOffset;
/*0x13c*/ bool               bEscapable;
/*0x13d*/ bool               bRightAnchoredToLeft;
/*0x140*/ uint32_t           BlinkFadeStartTime;
/*0x144*/ bool               ValidCXWnd;
/*0x145*/ uint8_t            FadeAlpha;
/*0x148*/ int                BlinkState;
/*0x14c*/ CXRect             ClientRect;
/*0x15c*/ CXRect             OldLocation;
/*0x16c*/ bool               bClickThroughMenuItemStatus;
...
/*0x1c4*/ bool               bUseInLayoutVertical;
/*0x1c8*/ CXStr              Tooltip;
/*0x1d0*/ int                VScrollMax;
/*0x1d4*/ bool               bAction;
/*0x1d8*/ int                RightOffset;
/*0x1dc*/ int                LeftOffset;
/*0x1e0*/ CXSize             MinClientSize;
/*0x1e8*/ bool               bActive;
/*0x1ec*/ CXSize             MaxClientSize;
/*0x1f4*/ uint32_t           WindowStyle;
/*0x1f8*/ bool               bUseInLayoutHorizontal;
/*0x200*/ CLayoutStrategy*   pLayoutStrategy;
/*0x208*/ CXWnd*             ParentWindow;
/*0x210*/ uint32_t           BlinkFadeDuration;
/*0x214*/ bool               bClickThroughToBackground;
/*0x218*/ COLORREF           CRNormal;
/*0x21c*/ bool               bClickThrough;
/*0x220*/ uint32_t           LastBlinkFadeRefreshTime;
/*0x228*/ CXWndDrawTemplate* DrawTemplate;
/*0x230*/ bool               bMaximized;
/*0x234*/ int                DeleteCount;
/*0x238*/ uint32_t           BackgroundDrawType;
/*0x240*/ CStaticTintedBlendAnimationTemplate* TitlePiece2;
/*0x248*/ bool               Faded;
/*0x24c*/ int                VScrollPos;
/*0x250*/ COLORREF           BGColor;
/*0x254*/ bool               MouseOver;
/*0x255*/ bool               bEscapableLocked;
/*0x258*/ int                ParentAndContextMenuArrayIndex;
/*0x260*/ CTextObjectInterface* pTextObject;
/*0x268*/ bool               bClientClipRectChanged;

// @end: CXWnd Members
/*0x269*/ bool               bUsesClassicUI;
/*0x26a*/ bool               bMouseOverEvent;
/*0x26c*/
...
constexpr size_t CSidlScreenWnd_size = 0x2D8; // @sizeof(CSidlScreenWnd) :: 2025-01-21 (test) @ 0x1405C18C1
...
constexpr size_t CEQXWndManager_size = 0x298; // @sizeof(CEQXWndManager) :: 2025-01-21 (test) @ 0x140191A35
