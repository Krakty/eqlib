...
constexpr size_t CGroupMember_size = 0x68; // @sizeof(CGroupMember) :: 2025-08-26 (test) @ 0x1402D8E9D
...
constexpr size_t PcClient_size = 0x3218; // @sizeof(PcClient) :: 2025-08-26 (test) @ 0x14028018B
