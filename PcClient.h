...
constexpr size_t CGroupMember_size = 0x68; // @sizeof(CGroupMember) :: 2025-08-14 (test) @ 0x1402D8B2D
...
constexpr size_t PcClient_size = 0x3218; // @sizeof(PcClient) :: 2025-08-14 (test) @ 0x14027FE9B
