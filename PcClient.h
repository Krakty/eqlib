...
constexpr size_t CGroupMember_size = 0x68; // @sizeof(CGroupMember) :: 2025-09-24 (test) @ 0x1402D9F13
...
constexpr size_t PcClient_size = 0x3218; // @sizeof(PcClient) :: 2025-09-24 (test) @ 0x14028176B
