...
constexpr size_t CGroupMember_size = 0x68; // @sizeof(CGroupMember) :: 2025-09-08 (test) @ 0x1402DA50D
...
constexpr size_t PcClient_size = 0x3218; // @sizeof(PcClient) :: 2025-09-08 (test) @ 0x140281CDB
