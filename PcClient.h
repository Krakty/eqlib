...
constexpr size_t CGroupMember_size = 0x68; // @sizeof(CGroupMember) :: 2025-06-09 (test) @ 0x1402D60EE
...
constexpr size_t PcClient_size = 0x3218; // @sizeof(PcClient) :: 2025-06-09 (test) @ 0x14027D74B
