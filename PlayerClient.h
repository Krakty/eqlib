...
/*0x01cd*/ uint8_t                  TitleVisible;
/*0x01d0*/ int64_t                  HPCurrent;
/*0x01d8*/ unsigned int             FishingETA;
/*0x01dc*/ unsigned int             NextSwim;
/*0x01e0*/ unsigned int             Zone;
/*0x01e4*/ int                      CurrIOState;
/*0x01e8*/ unsigned int             LastSecondaryUseTime;
/*0x01ec*/ float                    CameraOffset;
/*0x01f0*/ int                      ManaMax;
/*0x01f4*/ unsigned int             LastTrapDamageTime;
/*0x01f8*/ unsigned int             MinuteTimer;
/*0x01fc*/ float                    AnimationSpeedRelated;
/*0x0200*/ bool                     bAnimationOnPop;
/*0x0201*/ bool                     bOfflineMode;
/*0x0204*/ float                    MyWalkSpeed;
/*0x0208*/ CharacterZoneClient*     pCharacter;
/*0x0210*/ uint8_t                  Light;
/*0x0214*/ unsigned int             LastTimeStoodStill;
/*0x0218*/ uint8_t                  FD;
/*0x021c*/ unsigned int             SpellCooldownETA;
/*0x0220*/ bool                     bSummoned;
/*0x0224*/ int                      EnduranceCurrent;
/*0x0228*/ bool                     PvPFlag;
/*0x022c*/ int                      Unknown1;
/*0x0230*/ LaunchSpellData          CastingData;
/*0x0274*/ bool                     bBetaBuffed;
/*0x0278*/ unsigned int             NextIntimidateTime;
/*0x027c*/ float                    BearingToTarget;
/*0x0280*/ uint8_t                  GMRank;
/*0x0284*/ unsigned int             LastRefresh;
/*0x0288*/ char                     Handle[0x20];
/*0x02a8*/ bool                     bStationary;
/*0x02ac*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x02b4*/ char                     DraggingPlayer[0x40];
/*0x02f4*/ unsigned int             LoginSerial;
/*0x02f8*/ int                      SecondaryTintIndex;
/*0x02fc*/ int                      Deity;
/*0x0300*/ unsigned int             LastRangedUsedTime;
/*0x0304*/ int                      RealEstateItemId;
/*0x0308*/ int                      PrimaryTintIndex;
/*0x030c*/ int                      NpcTintIndex;
/*0x0310*/ int                      AFK;
/*0x0314*/ float                    ViewHeight;
/*0x0318*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0320*/ uint8_t                  CharClass;
/*0x0321*/ bool                     bBuffTimersOnHold;
/*0x0324*/ int                      Buyer;
/*0x0328*/ int                      HideMode;
...
/*0x033c*/ char                     Title[0x80];
/*0x03bc*/ int                      IsAttacking;
/*0x03c0*/ unsigned int             CorpseDragCount;
/*0x03c4*/ unsigned int             TimeStamp;
/*0x03c8*/ uint8_t                  Blind;
/*0x03d0*/ int64_t                  HPMax;
/*0x03d8*/ char                     DragNames[2][0x40];
/*0x0458*/ unsigned int             Meditating;
/*0x045c*/ uint8_t                  IsPassenger;
/*0x0460*/ unsigned int             StunTimer;
...
/*0x0488*/ uint8_t                  LastAttack;
/*0x0489*/ bool                     Mercenary;
/*0x048c*/ unsigned int             SpellGemETA[15];
/*0x04c8*/ EqItemGuid               realEstateItemGuid;
/*0x04da*/ char                     LoginRelated[0x20];
...
/*0x0514*/ float                    MerchantGreed;
/*0x0518*/ uint8_t                  FindBits;
/*0x0519*/ uint8_t                  InPvPArea;
/*0x051c*/ unsigned int             ACounter;
/*0x0520*/ uint8_t                  HoldingAnimation;
/*0x0521*/ bool                     bShowHelm;
/*0x0522*/ bool                     bAlwaysShowAura;
/*0x0523*/ bool                     LFG;
/*0x0524*/ int                      DoSpecialMelee;
/*0x0528*/ int                      SomeData[2];
/*0x0530*/ uint8_t                  StandState;
/*0x0538*/ unsigned int**           ppUDP;
/*0x0540*/ void*                    pTouchingSwitch;
/*0x0548*/ bool                     Sneak;
/*0x054c*/ int                      Anon;
/*0x0550*/ bool                     bSwitchMoved;
/*0x0554*/ CPhysicsInfo             LastCollision;
/*0x0584*/ int                      PetID;
/*0x0588*/ int                      Unknown3;
/*0x058c*/ uint8_t                  Level;
/*0x0590*/ int                      AltAttack;
/*0x0594*/ bool                     Linkdead;
/*0x0598*/ unsigned int             LastResendAddPlayerPacket;
/*0x05a0*/ int64_t                  GuildID;
/*0x05a8*/ unsigned int             LastPrimaryUseTime;
/*0x05ac*/ unsigned int             LastMealTime;
/*0x05b0*/ unsigned int             LastTick;
/*0x05b4*/ float                    RunSpeed;
/*0x05b8*/ char                     Suffix[0x80];
/*0x0638*/ uint8_t                  Original;
/*0x063c*/ int                      ManaCurrent;
/*0x0640*/ uint8_t                  FishingEvent;
/*0x0644*/ unsigned int             RespawnTimer;
/*0x0648*/ int                      RealEstateID;
...
constexpr size_t PlayerClient_size = 0x1F68; // @sizeof(PlayerClient) :: 2024-12-13 (test) @ 0x1402EB90E
