...
/*0x01e0*/ bool                     bSummoned;
/*0x01e4*/ unsigned int             LastMealTime;
/*0x01e8*/ int                      AFK;
/*0x01ec*/ int                      RealEstateID;
...
/*0x02fc*/ unsigned int             NextIntimidateTime;
/*0x0300*/ int                      AltAttack;
/*0x0304*/ uint8_t                  Light;
/*0x0305*/ bool                     bAnimationOnPop;
/*0x0306*/ uint8_t                  TitleVisible;
/*0x0308*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0310*/ char                     Title[0x80];
/*0x0390*/ unsigned int             SpellCooldownETA;
/*0x0394*/ uint8_t                  CharClass;
...
/*0x03a8*/ int                      Trader;
/*0x03ac*/ uint8_t                  FD;
/*0x03ad*/ uint8_t                  Original;
/*0x03ae*/ EqItemGuid               realEstateItemGuid;
/*0x03c0*/ unsigned int             LastTick;
/*0x03c4*/ uint8_t                  IntimidateCount;
/*0x03c8*/ unsigned int             TimeStamp;
/*0x03cc*/ float                    ViewHeight;
/*0x03d0*/ bool                     bStationary;
/*0x03d1*/ bool                     bTempPet;
/*0x03d4*/ unsigned int             Meditating;
/*0x03d8*/ bool                     bShowHelm;
/*0x03dc*/ int                      DoSpecialMelee;
/*0x03e0*/ char                     DraggingPlayer[0x40];
/*0x0420*/ uint8_t                  GMRank;
/*0x0424*/ unsigned int             SpellGemETA[15];
/*0x0460*/ bool                     bBuffTimersOnHold;
/*0x0464*/ int                      SecondaryTintIndex;
/*0x0468*/ uint8_t                  IsPassenger;
/*0x0469*/ bool                     bSwitchMoved;
/*0x046c*/ unsigned int             LastRangedUsedTime;
/*0x0470*/ uint8_t                  LastAttack;
/*0x0474*/ int                      Birthdate;
/*0x0478*/ int                      ManaMax;
/*0x047c*/ int                      PrimaryTintIndex;
/*0x0480*/ uint8_t                  Blind;
/*0x0484*/ unsigned int             LastSecondaryUseTime;
/*0x0488*/ CPhysicsInfo             LastCollision;
/*0x04b8*/ unsigned int             LastTrapDamageTime;
/*0x04c0*/ CharacterZoneClient*     pCharacter;
/*0x04c8*/ uint8_t                  StandState;
/*0x04d0*/ unsigned int**           ppUDP;
/*0x04d8*/ float                    BearingToTarget;
/*0x04dc*/ bool                     PvPFlag;
/*0x04e0*/ int                      SomeData[2];
/*0x04e8*/ float                    FallingStartZ;
/*0x04ec*/ char                     DragNames[2][0x40];
/*0x056c*/ bool                     Mercenary;
/*0x0570*/ float                    GetMeleeRangeVar1;
/*0x0574*/ unsigned int             EnduranceMax;
/*0x0578*/ int64_t                  HPCurrent;
/*0x0580*/ int                      HideMode;
/*0x0584*/ int                      Unknown1;
/*0x0588*/ bool                     LFG;
/*0x0589*/ uint8_t                  InPvPArea;
/*0x058c*/ unsigned int             MasterID;
/*0x0590*/ int                      ManaCurrent;
/*0x0594*/ unsigned int             LastTimeStoodStill;
/*0x0598*/ int                      Unknown4;
/*0x059c*/ unsigned int             LastPrimaryUseTime;
/*0x05a0*/ SPAWNINFO*               pViewPlayer;
/*0x05a8*/ int                      Unknown3;
/*0x05ac*/ unsigned int             CorpseDragCount;
/*0x05b0*/ LaunchSpellData          CastingData;
/*0x05f4*/ int                      CurrIOState;
/*0x05f8*/ int                      Anon;
/*0x05fc*/ char                     LoginRelated[0x20];
/*0x061c*/ float                    MissileRangeToTarget;
/*0x0620*/ unsigned int             Zone;
/*0x0624*/ int                      PetID;
/*0x0628*/ uint8_t                  HoldingAnimation;
/*0x062c*/ int                      IsAttacking;
/*0x0630*/ bool                     bAlwaysShowAura;
/*0x0638*/ void*                    pTouchingSwitch;
/*0x0640*/ unsigned int             FishingETA;
