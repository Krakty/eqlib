...
/*0x01cc*/ unsigned int             Zone;
/*0x01d0*/ bool                     bAnimationOnPop;
/*0x01d4*/ unsigned int             ACounter;
/*0x01d8*/ void*                    pTouchingSwitch;
/*0x01e0*/ unsigned int             LastTrapDamageTime;
/*0x01e4*/ int                      ManaMax;
/*0x01e8*/ int                      IsAttacking;
/*0x01ec*/ bool                     bShowHelm;
/*0x01f0*/ int                      ManaCurrent;
/*0x01f4*/ bool                     bTempPet;
/*0x01f5*/ bool                     bSwitchMoved;
/*0x01f8*/ int                      EnduranceCurrent;
/*0x0200*/ int64_t                  HPCurrent;
/*0x0208*/ bool                     bBetaBuffed;
/*0x020c*/ unsigned int             NextIntimidateTime;
/*0x0210*/ float                    FallingStartZ;
/*0x0214*/ unsigned int             LastRefresh;
/*0x0218*/ char                     GM;
/*0x0220*/ CharacterZoneClient*     pCharacter;
/*0x0228*/ SPAWNINFO*               pViewPlayer;
/*0x0230*/ bool                     bStationary;
/*0x0234*/ unsigned int             FishingETA;
/*0x0238*/ uint8_t                  CharClass;
/*0x0239*/ bool                     LFG;
/*0x023c*/ int                      SecondaryTintIndex;
/*0x0240*/ int                      AFK;
/*0x0244*/ unsigned int             Meditating;
/*0x0248*/ uint8_t                  FindBits;
/*0x024c*/ unsigned int             RespawnTimer;
/*0x0250*/ unsigned int             LoginSerial;
/*0x0254*/ int                      CurrIOState;
/*0x0258*/ bool                     Mercenary;
/*0x025c*/ int                      berserker;
/*0x0260*/ int                      NpcTintIndex;
/*0x0264*/ unsigned int             CorpseDragCount;
/*0x0268*/ int                      Birthdate;
/*0x026c*/ unsigned int             LastTick;
/*0x0270*/ char                     LoginRelated[0x20];
/*0x0290*/ char                     DraggingPlayer[0x40];
/*0x02d0*/ float                    MissileRangeToTarget;
/*0x02d4*/ float                    AnimationSpeedRelated;
/*0x02d8*/ float                    MyWalkSpeed;
/*0x02dc*/ uint8_t                  StandState;
/*0x02dd*/ uint8_t                  FD;
/*0x02e0*/ CPhysicsInfo             LastCollision;
/*0x0310*/ int                      AltAttack;
/*0x0314*/ uint8_t                  IsPassenger;
/*0x0318*/ unsigned int             LastRangedUsedTime;
/*0x031c*/ unsigned int             LastTimeStoodStill;
/*0x0320*/ unsigned int             LastPrimaryUseTime;
/*0x0324*/ unsigned int             SpellCooldownETA;
/*0x0328*/ int                      WarCry;
/*0x032c*/ unsigned int             LastResendAddPlayerPacket;
/*0x0330*/ bool                     bAttackRelated;
/*0x0338*/ unsigned int**           ppUDP;
/*0x0340*/ bool                     PvPFlag;
/*0x0341*/ bool                     Sneak;
/*0x0344*/ unsigned int             TimeStamp;
/*0x0348*/ char                     Title[0x80];
/*0x03c8*/ char                     DragNames[2][0x40];
/*0x0448*/ int                      PrimaryTintIndex;
/*0x044c*/ float                    ViewHeight;
/*0x0450*/ unsigned int             StunTimer;
/*0x0454*/ EqItemGuid               realEstateItemGuid;
/*0x0466*/ char                     Suffix[0x80];
/*0x04e8*/ int64_t                  GuildID;
/*0x04f0*/ int                      Unknown4;
/*0x04f4*/ float                    GetMeleeRangeVar1;
/*0x04f8*/ uint8_t                  IntimidateCount;
/*0x04f9*/ uint8_t                  Blind;
/*0x04fa*/ bool                     bBuffTimersOnHold;
/*0x04fc*/ unsigned int             SitStartTime;
/*0x0500*/ unsigned int             NextSwim;
/*0x0504*/ bool                     bSummoned;
/*0x0505*/ uint8_t                  Original;
/*0x0506*/ bool                     Linkdead;
/*0x0508*/ float                    RunSpeed;
/*0x050c*/ int                      DoSpecialMelee;
/*0x0510*/ char                     Handle[0x20];
/*0x0530*/ int                      Unknown3;
/*0x0534*/ unsigned int             EnduranceMax;
/*0x0538*/ int                      RealEstateItemId;
/*0x053c*/ uint8_t                  HoldingAnimation;
/*0x0540*/ float                    CameraOffset;
/*0x0544*/ int                      Unknown1;
/*0x0548*/ uint8_t                  FishingEvent;
/*0x054c*/ unsigned int             MasterID;
/*0x0550*/ float                    MerchantGreed;
/*0x0554*/ int                      HideMode;
/*0x0558*/ uint8_t                  InPvPArea;
/*0x0560*/ void*                    pRaceGenderInfo;
/*0x0568*/ bool                     bAlwaysShowAura;
/*0x0570*/ int64_t                  HPMax;
/*0x0578*/ int                      SomeData[2];
/*0x0580*/ uint8_t                  Light;
/*0x0584*/ int                      PetID;
/*0x0588*/ unsigned int             SpellGemETA[15];
/*0x05c4*/ LaunchSpellData          CastingData;
/*0x0608*/ int                      Buyer;
/*0x060c*/ uint8_t                  LastAttack;
/*0x0610*/ int                      RealEstateID;
/*0x0614*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x061c*/ uint8_t                  GMRank;
/*0x061d*/ bool                     bOfflineMode;
/*0x0620*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0628*/ unsigned int             LastSecondaryUseTime;
/*0x062c*/ uint8_t                  TitleVisible;
/*0x0630*/ float                    BearingToTarget;
/*0x0634*/ unsigned int             LastMealTime;
/*0x0638*/ int                      Trader;
/*0x063c*/ int                      Anon;
/*0x0640*/ uint8_t                  Level;
/*0x0644*/ unsigned int             MinuteTimer;
/*0x0648*/ int                      Deity;
...
constexpr size_t PlayerClient_size = 0x20C8; // @sizeof(PlayerClient) :: 2025-07-07 (test) @ 0x1402F7E7E
