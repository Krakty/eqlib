...
/*0x01cc*/ int                      EnduranceCurrent;
/*0x01d0*/ float                    GetMeleeRangeVar1;
/*0x01d4*/ char                     LoginRelated[0x20];
/*0x01f4*/ int                      CurrIOState;
/*0x01f8*/ unsigned int**           ppUDP;
/*0x0200*/ int                      Buyer;
/*0x0204*/ uint8_t                  FindBits;
/*0x0205*/ char                     DragNames[2][0x40];
/*0x0288*/ unsigned int             LastTick;
/*0x028c*/ int                      IsAttacking;
/*0x0290*/ int                      AFK;
/*0x0294*/ unsigned int             StunTimer;
/*0x0298*/ int                      Birthdate;
/*0x029c*/ uint8_t                  Original;
/*0x02a0*/ float                    CameraOffset;
/*0x02a4*/ unsigned int             ACounter;
/*0x02a8*/ unsigned int             MinuteTimer;
/*0x02ac*/ uint8_t                  GMRank;
/*0x02b0*/ void*                    pTouchingSwitch;
/*0x02b8*/ bool                     bBuffTimersOnHold;
/*0x02bc*/ int                      RealEstateID;
/*0x02c0*/ uint8_t                  FD;
/*0x02c4*/ int                      SomeData[2];
/*0x02cc*/ unsigned int             LoginSerial;
/*0x02d0*/ int                      RealEstateItemId;
/*0x02d4*/ char                     DraggingPlayer[0x40];
/*0x0314*/ unsigned int             NextSwim;
/*0x0318*/ SPAWNINFO*               pViewPlayer;
/*0x0320*/ float                    MerchantGreed;
/*0x0324*/ int                      Unknown1;
/*0x0328*/ unsigned int             EnduranceMax;
/*0x032c*/ int                      Trader;
/*0x0330*/ float                    MyWalkSpeed;
/*0x0334*/ unsigned int             LastMealTime;
/*0x0338*/ int64_t                  GuildID;
/*0x0340*/ uint8_t                  Light;
/*0x0344*/ int                      SecondaryTintIndex;
/*0x0348*/ int                      NpcTintIndex;
/*0x034c*/ bool                     bStationary;
/*0x034d*/ bool                     Sneak;
/*0x034e*/ bool                     PvPFlag;
/*0x0350*/ unsigned int             SpellGemETA[15];
/*0x038c*/ uint8_t                  InPvPArea;
/*0x038d*/ bool                     bSwitchMoved;
/*0x0390*/ CharacterZoneClient*     pCharacter;
/*0x0398*/ int                      berserker;
/*0x039c*/ bool                     bOfflineMode;
/*0x039d*/ uint8_t                  TitleVisible;
/*0x03a0*/ float                    AnimationSpeedRelated;
/*0x03a4*/ bool                     bTempPet;
/*0x03a8*/ int                      ManaMax;
/*0x03ac*/ uint8_t                  LastAttack;
/*0x03b0*/ unsigned int             LastPrimaryUseTime;
/*0x03b4*/ char                     Suffix[0x80];
/*0x0434*/ unsigned int             CorpseDragCount;
/*0x0438*/ unsigned int             NextIntimidateTime;
/*0x043c*/ int                      ManaCurrent;
/*0x0440*/ char                     Title[0x80];
/*0x04c0*/ bool                     bSummoned;
/*0x04c4*/ unsigned int             FishingETA;
/*0x04c8*/ bool                     bShowHelm;
/*0x04c9*/ bool                     bBetaBuffed;
/*0x04cc*/ unsigned int             Meditating;
/*0x04d0*/ bool                     bAlwaysShowAura;
/*0x04d4*/ CPhysicsInfo             LastCollision;
/*0x0504*/ unsigned int             LastResendAddPlayerPacket;
/*0x0508*/ uint8_t                  IsPassenger;
/*0x0509*/ uint8_t                  IntimidateCount;
/*0x050c*/ unsigned int             LastSecondaryUseTime;
/*0x0510*/ char                     Handle[0x20];
/*0x0530*/ bool                     Linkdead;
/*0x0534*/ int                      Unknown4;
/*0x0538*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0540*/ unsigned int             LastRangedUsedTime;
/*0x0544*/ bool                     LFG;
/*0x0548*/ int                      Anon;
/*0x054c*/ bool                     Mercenary;
/*0x054d*/ bool                     bAttackRelated;
/*0x0550*/ int                      PetID;
/*0x0554*/ int                      AltAttack;
/*0x0558*/ unsigned int             RespawnTimer;
/*0x055c*/ LaunchSpellData          CastingData;
/*0x05a0*/ float                    BearingToTarget;
/*0x05a4*/ int                      Unknown3;
...
/*0x05c8*/ bool                     bAnimationOnPop;
/*0x05c9*/ uint8_t                  FishingEvent;
/*0x05cc*/ int                      DoSpecialMelee;
/*0x05d0*/ unsigned int             LastTrapDamageTime;
/*0x05d4*/ unsigned int             MasterID;
/*0x05d8*/ uint8_t                  Blind;
/*0x05e0*/ int64_t                  HPCurrent;
/*0x05e8*/ uint8_t                  CharClass;
/*0x05e9*/ EqItemGuid               realEstateItemGuid;
/*0x05fb*/ uint8_t                  Level;
/*0x05fc*/ float                    FallingStartZ;
/*0x0600*/ int                      WarCry;
/*0x0604*/ float                    MissileRangeToTarget;
/*0x0608*/ float                    RunSpeed;
/*0x060c*/ unsigned int             SpellCooldownETA;
/*0x0610*/ char                     GM;
/*0x0614*/ float                    ViewHeight;
/*0x0618*/ int64_t                  HPMax;
/*0x0620*/ uint8_t                  StandState;
/*0x0624*/ int                      Deity;
/*0x0628*/ uint8_t                  HoldingAnimation;
/*0x062c*/ unsigned int             LastTimeStoodStill;
/*0x0630*/ unsigned int             SitStartTime;
/*0x0634*/ unsigned int             LastRefresh;
/*0x0638*/ unsigned int             TimeStamp;
...
constexpr size_t PlayerClient_size = 0x1FB0; // @sizeof(PlayerClient) :: 2025-02-03 (test) @ 0x1402F10BE
