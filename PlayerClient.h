...
/*0x01d8*/ bool                     bBuffTimersOnHold;
/*0x01dc*/ unsigned int             SpellCooldownETA;
/*0x01e0*/ float                    MerchantGreed;
/*0x01e4*/ uint8_t                  FishingEvent;
/*0x01e8*/ unsigned int             LoginSerial;
/*0x01ec*/ uint8_t                  IsPassenger;
/*0x01f0*/ int                      RealEstateItemId;
/*0x01f4*/ uint8_t                  HoldingAnimation;
/*0x01f8*/ int                      AltAttack;
/*0x01fc*/ bool                     Linkdead;
/*0x01fd*/ uint8_t                  Original;
/*0x0200*/ int                      ManaMax;
/*0x0204*/ bool                     bStationary;
/*0x0208*/ int                      Unknown3;
/*0x0210*/ void*                    pRaceGenderInfo;
/*0x0218*/ unsigned int**           ppUDP;
/*0x0220*/ unsigned int             NextSwim;
/*0x0224*/ EqItemGuid               realEstateItemGuid;
/*0x0238*/ unsigned int             MasterID;
/*0x023c*/ char                     Title[0x80];
/*0x02bc*/ char                     Handle[0x20];
/*0x02dc*/ bool                     bShowHelm;
/*0x02e0*/ CPhysicsInfo             LastCollision;
/*0x0310*/ int                      Trader;
/*0x0314*/ char                     Suffix[0x80];
/*0x0398*/ void*                    pTouchingSwitch;
/*0x03a0*/ float                    BearingToTarget;
/*0x03a4*/ int                      SecondaryTintIndex;
/*0x03a8*/ int                      AFK;
/*0x03ac*/ uint8_t                  Light;
/*0x03b0*/ unsigned int             EnduranceMax;
/*0x03b4*/ unsigned int             MinuteTimer;
/*0x03b8*/ int                      EnduranceCurrent;
/*0x03bc*/ bool                     bAttackRelated;
/*0x03c0*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x03c8*/ uint8_t                  FindBits;
/*0x03cc*/ unsigned int             Meditating;
/*0x03d0*/ char                     GM;
/*0x03d1*/ bool                     Sneak;
/*0x03d2*/ uint8_t                  IntimidateCount;
/*0x03d8*/ int64_t                  HPCurrent;
/*0x03e0*/ uint8_t                  StandState;
/*0x03e4*/ unsigned int             NextIntimidateTime;
/*0x03e8*/ float                    MyWalkSpeed;
/*0x03ec*/ int                      DoSpecialMelee;
/*0x03f0*/ int                      WarCry;
/*0x03f4*/ unsigned int             SpellGemETA[15];
/*0x0430*/ float                    ViewHeight;
/*0x0434*/ int                      HideMode;
/*0x0438*/ LaunchSpellData          CastingData;
/*0x0480*/ CharacterZoneClient*     pCharacter;
/*0x0488*/ float                    FallingStartZ;
/*0x048c*/ float                    AnimationSpeedRelated;
/*0x0490*/ int                      CurrIOState;
/*0x0494*/ int                      berserker;
/*0x0498*/ float                    RunSpeed;
/*0x049c*/ unsigned int             FishingETA;
/*0x04a0*/ int                      IsAttacking;
/*0x04a4*/ unsigned int             LastMealTime;
/*0x04a8*/ bool                     LFG;
/*0x04a9*/ bool                     bSummoned;
/*0x04ac*/ int                      NpcTintIndex;
/*0x04b0*/ float                    GetMeleeRangeVar1;
/*0x04b4*/ float                    CameraOffset;
/*0x04b8*/ char                     LoginRelated[0x20];
/*0x04d8*/ uint8_t                  Level;
/*0x04dc*/ unsigned int             LastTick;
/*0x04e0*/ unsigned int             LastRefresh;
/*0x04e4*/ unsigned int             LastRangedUsedTime;
/*0x04e8*/ int                      PetID;
/*0x04ec*/ uint8_t                  GMRank;
/*0x04f0*/ SPAWNINFO*               pViewPlayer;
/*0x04f8*/ unsigned int             TimeStamp;
/*0x04fc*/ int                      SomeData[2];
/*0x0504*/ unsigned int             CorpseDragCount;
/*0x0508*/ unsigned int             LastPrimaryUseTime;
/*0x050c*/ uint8_t                  LastAttack;
/*0x0510*/ unsigned int             ACounter;
/*0x0514*/ bool                     PvPFlag;
/*0x0515*/ char                     DragNames[2][0x40];
/*0x0595*/ uint8_t                  TitleVisible;
/*0x0598*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x05a0*/ bool                     bOfflineMode;
/*0x05a4*/ int                      Anon;
/*0x05a8*/ uint8_t                  FD;
/*0x05ac*/ float                    MissileRangeToTarget;
/*0x05b0*/ int                      Unknown4;
/*0x05b4*/ unsigned int             LastTrapDamageTime;
/*0x05b8*/ int                      Buyer;
/*0x05bc*/ int                      RealEstateID;
/*0x05c0*/ int                      Birthdate;
/*0x05c4*/ unsigned int             SitStartTime;
/*0x05c8*/ int64_t                  GuildID;
/*0x05d0*/ uint8_t                  CharClass;
/*0x05d4*/ unsigned int             RespawnTimer;
/*0x05d8*/ int                      Unknown1;
/*0x05dc*/ unsigned int             LastSecondaryUseTime;
/*0x05e0*/ bool                     bTempPet;
/*0x05e1*/ uint8_t                  Blind;
/*0x05e2*/ uint8_t                  InPvPArea;
/*0x05e3*/ char                     DraggingPlayer[0x40];
/*0x0624*/ unsigned int             LastTimeStoodStill;
/*0x0628*/ unsigned int             LastResendAddPlayerPacket;
/*0x062c*/ bool                     bSwitchMoved;
/*0x0630*/ int                      PrimaryTintIndex;
/*0x0634*/ bool                     bAnimationOnPop;
/*0x0635*/ bool                     bAlwaysShowAura;
/*0x0638*/ int                      Deity;
/*0x063c*/ unsigned int             StunTimer;
/*0x0640*/ bool                     Mercenary;
/*0x0644*/ int                      ManaCurrent;
/*0x0648*/ unsigned int             Zone;
/*0x064c*/ bool                     bBetaBuffed;
...
constexpr size_t PlayerClient_size = 0x20C8; // @sizeof(PlayerClient) :: 2025-04-22 (test) @ 0x1402F62DE
