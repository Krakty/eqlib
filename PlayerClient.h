...
/*0x01d4*/ unsigned int             LastMealTime;
/*0x01d8*/ uint8_t                  TitleVisible;
/*0x01d9*/ bool                     LFG;
/*0x01dc*/ unsigned int             LastResendAddPlayerPacket;
/*0x01e0*/ CharacterZoneClient*     pCharacter;
/*0x01e8*/ int                      NpcTintIndex;
/*0x01ec*/ uint8_t                  HoldingAnimation;
/*0x01ed*/ uint8_t                  Light;
/*0x01ee*/ uint8_t                  Original;
/*0x01f0*/ int                      PetID;
/*0x01f4*/ bool                     bBuffTimersOnHold;
/*0x01f8*/ int                      Trader;
/*0x01fc*/ int                      RealEstateID;
/*0x0200*/ int                      RealEstateItemId;
/*0x0204*/ unsigned int             Zone;
/*0x0208*/ SPAWNINFO*               pViewPlayer;
/*0x0210*/ int                      AFK;
/*0x0214*/ int                      IsAttacking;
/*0x0218*/ char                     Handle[0x20];
/*0x0238*/ char                     DragNames[2][0x40];
/*0x02b8*/ unsigned int             RespawnTimer;
/*0x02bc*/ uint8_t                  FishingEvent;
/*0x02bd*/ bool                     Mercenary;
/*0x02be*/ bool                     bAnimationOnPop;
/*0x02c0*/ int                      Unknown3;
/*0x02c8*/ int64_t                  GuildID;
/*0x02d0*/ uint8_t                  IsPassenger;
/*0x02d1*/ bool                     bStationary;
/*0x02d4*/ unsigned int             EnduranceMax;
/*0x02d8*/ float                    FallingStartZ;
/*0x02dc*/ int                      Birthdate;
/*0x02e0*/ unsigned int             LastRangedUsedTime;
/*0x02e4*/ uint8_t                  Level;
/*0x02e8*/ int                      WarCry;
/*0x02ec*/ bool                     bOfflineMode;
/*0x02ed*/ bool                     bShowHelm;
/*0x02f0*/ int                      HideMode;
/*0x02f4*/ unsigned int             NextSwim;
/*0x02f8*/ EqItemGuid               realEstateItemGuid;
/*0x030c*/ unsigned int             LastTick;
/*0x0310*/ int                      ManaCurrent;
/*0x0314*/ unsigned int             ACounter;
/*0x0318*/ unsigned int             MasterID;
/*0x031c*/ bool                     bTempPet;
/*0x0320*/ float                    GetMeleeRangeVar1;
/*0x0324*/ bool                     Sneak;
/*0x0325*/ uint8_t                  InPvPArea;
/*0x0328*/ float                    AnimationSpeedRelated;
/*0x032c*/ bool                     bAttackRelated;
/*0x032d*/ char                     LoginRelated[0x20];
/*0x034d*/ uint8_t                  StandState;
/*0x034e*/ bool                     bSwitchMoved;
/*0x0350*/ int                      Anon;
/*0x0354*/ unsigned int             SpellGemETA[15];
/*0x0390*/ unsigned int             LastPrimaryUseTime;
/*0x0394*/ uint8_t                  LastAttack;
/*0x0398*/ int                      Deity;
/*0x039c*/ int                      DoSpecialMelee;
/*0x03a0*/ int                      berserker;
/*0x03a8*/ void*                    pRaceGenderInfo;
/*0x03b0*/ unsigned int             MinuteTimer;
/*0x03b4*/ char                     Title[0x80];
/*0x0434*/ uint8_t                  GMRank;
/*0x0438*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
...
/*0x0464*/ unsigned int             SitStartTime;
/*0x0468*/ unsigned int             LastSecondaryUseTime;
/*0x046c*/ float                    CameraOffset;
/*0x0470*/ bool                     bBetaBuffed;
/*0x0471*/ bool                     Linkdead;
/*0x0474*/ int                      SomeData[2];
/*0x047c*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0484*/ LaunchSpellData          CastingData;
/*0x04c8*/ int                      CurrIOState;
/*0x04cc*/ unsigned int             StunTimer;
/*0x04d0*/ uint8_t                  Blind;
/*0x04d4*/ int                      Unknown4;
/*0x04d8*/ char                     DraggingPlayer[0x40];
/*0x0518*/ float                    RunSpeed;
/*0x051c*/ float                    MyWalkSpeed;
/*0x0520*/ unsigned int             LastTrapDamageTime;
/*0x0524*/ uint8_t                  CharClass;
/*0x0528*/ float                    BearingToTarget;
/*0x052c*/ unsigned int             SpellCooldownETA;
/*0x0530*/ int64_t                  HPMax;
/*0x0538*/ unsigned int             NextIntimidateTime;
/*0x053c*/ CPhysicsInfo             LastCollision;
/*0x056c*/ uint8_t                  FindBits;
/*0x056d*/ bool                     bSummoned;
/*0x0570*/ unsigned int             Meditating;
/*0x0574*/ uint8_t                  FD;
/*0x0578*/ void*                    pTouchingSwitch;
/*0x0580*/ int                      AltAttack;
/*0x0588*/ unsigned int**           ppUDP;
/*0x0590*/ char                     Suffix[0x80];
...
/*0x061c*/ int                      Unknown1;
/*0x0620*/ int                      ManaMax;
/*0x0624*/ float                    MissileRangeToTarget;
/*0x0628*/ unsigned int             LoginSerial;
/*0x062c*/ bool                     bAlwaysShowAura;
...
constexpr size_t PlayerClient_size = 0x20B0; // @sizeof(PlayerClient) :: 2025-08-11 (test) @ 0x1402F9B4E
