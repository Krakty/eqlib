...
/*0x01cc*/ unsigned int             TimeStamp;
/*0x01d0*/ bool                     LFG;
/*0x01d4*/ unsigned int             LoginSerial;
/*0x01d8*/ int                      CurrIOState;
/*0x01e0*/ unsigned int**           ppUDP;
/*0x01e8*/ int                      PetID;
/*0x01ec*/ uint8_t                  Blind;
/*0x01ed*/ bool                     bAnimationOnPop;
/*0x01f0*/ void*                    pTouchingSwitch;
/*0x01f8*/ unsigned int             SpellCooldownETA;
/*0x01fc*/ uint8_t                  IsPassenger;
/*0x0200*/ unsigned int             FishingETA;
/*0x0204*/ int                      Birthdate;
/*0x0208*/ unsigned int             StunTimer;
/*0x020c*/ int                      berserker;
/*0x0210*/ int                      Unknown4;
/*0x0214*/ float                    BearingToTarget;
/*0x0218*/ bool                     bBuffTimersOnHold;
/*0x021c*/ int                      Buyer;
/*0x0220*/ unsigned int             LastTrapDamageTime;
/*0x0224*/ uint8_t                  LastAttack;
/*0x0228*/ unsigned int             MinuteTimer;
/*0x022c*/ bool                     bTempPet;
/*0x022d*/ char                     Title[0x80];
/*0x02b0*/ float                    CameraOffset;
/*0x02b4*/ unsigned int             SitStartTime;
/*0x02b8*/ unsigned int             RespawnTimer;
/*0x02bc*/ int                      DoSpecialMelee;
/*0x02c0*/ LaunchSpellData          CastingData;
/*0x0304*/ unsigned int             LastPrimaryUseTime;
/*0x0308*/ uint8_t                  IntimidateCount;
/*0x030c*/ float                    MerchantGreed;
/*0x0310*/ uint8_t                  Original;
/*0x0314*/ CPhysicsInfo             LastCollision;
/*0x0344*/ bool                     Mercenary;
/*0x0348*/ int                      Trader;
/*0x034c*/ bool                     Sneak;
/*0x0350*/ float                    GetMeleeRangeVar1;
/*0x0354*/ char                     LoginRelated[0x20];
/*0x0374*/ unsigned int             LastMealTime;
/*0x0378*/ int                      AFK;
/*0x037c*/ int                      Unknown1;
/*0x0380*/ uint8_t                  FindBits;
/*0x0384*/ float                    FallingStartZ;
/*0x0388*/ uint8_t                  InPvPArea;
/*0x0389*/ uint8_t                  Light;
/*0x038a*/ EqItemGuid               realEstateItemGuid;
/*0x039c*/ uint8_t                  FD;
/*0x03a0*/ unsigned int             CorpseDragCount;
/*0x03a4*/ unsigned int             LastRangedUsedTime;
/*0x03a8*/ uint8_t                  StandState;
/*0x03ac*/ unsigned int             LastRefresh;
/*0x03b0*/ char                     Suffix[0x80];
/*0x0430*/ uint8_t                  FishingEvent;
/*0x0434*/ int                      EnduranceCurrent;
/*0x0438*/ unsigned int             NextSwim;
/*0x043c*/ int                      AltAttack;
/*0x0440*/ char                     DragNames[2][0x40];
/*0x04c0*/ int64_t                  GuildID;
/*0x04c8*/ int                      Anon;
/*0x04cc*/ int                      SomeData[2];
/*0x04d4*/ unsigned int             ACounter;
/*0x04d8*/ CharacterZoneClient*     pCharacter;
/*0x04e0*/ int                      IsAttacking;
/*0x04e4*/ bool                     bOfflineMode;
/*0x04e5*/ uint8_t                  TitleVisible;
/*0x04e8*/ int                      ManaMax;
/*0x04ec*/ int                      WarCry;
/*0x04f0*/ int                      NpcTintIndex;
/*0x04f4*/ unsigned int             LastSecondaryUseTime;
/*0x04f8*/ unsigned int             LastTimeStoodStill;
/*0x04fc*/ int                      Unknown3;
/*0x0500*/ uint8_t                  HoldingAnimation;
/*0x0504*/ unsigned int             SpellGemETA[15];
/*0x0540*/ char                     Handle[0x20];
/*0x0560*/ unsigned int             MasterID;
/*0x0564*/ int                      SecondaryTintIndex;
/*0x0568*/ unsigned int             Meditating;
/*0x056c*/ float                    AnimationSpeedRelated;
/*0x0570*/ float                    RunSpeed;
/*0x0574*/ unsigned int             LastTick;
/*0x0578*/ unsigned int             Zone;
/*0x057c*/ unsigned int             EnduranceMax;
/*0x0580*/ uint8_t                  CharClass;
/*0x0588*/ int64_t                  HPMax;
/*0x0590*/ bool                     bAttackRelated;
/*0x0591*/ uint8_t                  Level;
/*0x0592*/ bool                     PvPFlag;
/*0x0593*/ bool                     bShowHelm;
/*0x0594*/ float                    ViewHeight;
/*0x0598*/ int                      RealEstateID;
/*0x05a0*/ SPAWNINFO*               pViewPlayer;
/*0x05a8*/ float                    MissileRangeToTarget;
/*0x05ac*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x05b8*/ void*                    pRaceGenderInfo;
/*0x05c0*/ bool                     bBetaBuffed;
/*0x05c1*/ bool                     bSummoned;
/*0x05c4*/ int                      Deity;
/*0x05c8*/ bool                     bStationary;
/*0x05cc*/ int                      RealEstateItemId;
/*0x05d0*/ int                      PrimaryTintIndex;
/*0x05d4*/ bool                     bSwitchMoved;
/*0x05d8*/ unsigned int             LastResendAddPlayerPacket;
/*0x05dc*/ unsigned int             NextIntimidateTime;
/*0x05e0*/ int                      ManaCurrent;
/*0x05e4*/ bool                     bAlwaysShowAura;
/*0x05e5*/ uint8_t                  GMRank;
/*0x05e8*/ float                    MyWalkSpeed;
/*0x05ec*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x05f4*/ int                      HideMode;
/*0x05f8*/ bool                     Linkdead;
/*0x05f9*/ char                     DraggingPlayer[0x40];
/*0x0639*/ char                     GM;
...
constexpr size_t PlayerClient_size = 0x1FB8; // @sizeof(PlayerClient) :: 2025-01-21 (test) @ 0x1402EE36E
...
/*0x1f00*/ HashList<uint64_t, 5> BardMelodyQueue; // /queuemelody related - definitely not a HashList
/*0x1f48*/ int               CurrentBardTwistIndex;
/*0x1f4c*/ int               CurrentBardTwistIndex2;
/*0x1f50*/ PlayerPhysicsClient mPlayerPhysicsClient;
/*0x1f88*/ int               SpawnStatus[6];
/*0x1fa0*/ int               BannerIndex0;                 // guild banners
/*0x1fa4*/ int               BannerIndex1;
/*0x1fa8*/ ARGBCOLOR         BannerTint0;
/*0x1fac*/ ARGBCOLOR         BannerTint1;
/*0x1fb0*/ int               MountAnimationRelated;
/*0x1fb4*/ bool              bGuildShowAnim;               // or sprite? need to check
/*0x1fb5*/ bool              bWaitingForPort;
/*0x1fb8*/
