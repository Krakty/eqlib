...
/*0x02a8*/ int64_t                  GuildID;
/*0x02b0*/ float                    MyWalkSpeed;
/*0x02b4*/ int                      Birthdate;
/*0x02b8*/ unsigned int**           ppUDP;
/*0x02c0*/ char                     LoginRelated[0x20];
/*0x02e0*/ float                    GetMeleeRangeVar1;
/*0x02e4*/ unsigned int             LastTrapDamageTime;
/*0x02e8*/ uint8_t                  IntimidateCount;
/*0x02ec*/ int                      HideMode;
/*0x02f0*/ unsigned int             FishingETA;
/*0x02f4*/ unsigned int             LastMealTime;
/*0x02f8*/ int                      Trader;
/*0x02fc*/ unsigned int             LastRefresh;
/*0x0300*/ int                      DoSpecialMelee;
/*0x0308*/ void*                    pRaceGenderInfo;
/*0x0310*/ float                    MissileRangeToTarget;
/*0x0314*/ unsigned int             Meditating;
/*0x0318*/ bool                     bOfflineMode;
/*0x0319*/ EqItemGuid               realEstateItemGuid;
/*0x032c*/ float                    RunSpeed;
/*0x0330*/ float                    CameraOffset;
/*0x0334*/ unsigned int             ACounter;
/*0x0338*/ unsigned int             NextIntimidateTime;
/*0x033c*/ CPhysicsInfo             LastCollision;
/*0x036c*/ int                      AltAttack;
/*0x0370*/ char                     Title[0x80];
/*0x03f0*/ unsigned int             Zone;
/*0x03f4*/ float                    ViewHeight;
/*0x03f8*/ bool                     bShowHelm;
/*0x03f9*/ uint8_t                  IsPassenger;
/*0x03fa*/ uint8_t                  TitleVisible;
/*0x03fb*/ bool                     Mercenary;
/*0x03fc*/ bool                     PvPFlag;
/*0x0400*/ float                    FallingStartZ;
/*0x0404*/ uint8_t                  Level;
/*0x0405*/ bool                     Linkdead;
/*0x0408*/ int                      Deity;
/*0x040c*/ unsigned int             LastTimeStoodStill;
/*0x0410*/ char                     Suffix[0x80];
/*0x0490*/ int                      EnduranceCurrent;
...
// @sizeof(PlayerClient) == 0x1f68 :: 2024-10-30 (test) @ 0x1402ea4ee
