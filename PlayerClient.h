...
/*0x01e1*/ EqItemGuid               realEstateItemGuid;
/*0x01f4*/ float                    ViewHeight;
/*0x01f8*/ uint8_t                  StandState;
/*0x01fc*/ unsigned int             LastMealTime;
/*0x0200*/ float                    AnimationSpeedRelated;
/*0x0204*/ int                      Trader;
/*0x0208*/ unsigned int             LastTrapDamageTime;
/*0x020c*/ char                     LoginRelated[0x20];
/*0x022c*/ unsigned int             CorpseDragCount;
/*0x0230*/ int                      Unknown3;
/*0x0234*/ unsigned int             TimeStamp;
/*0x0238*/ unsigned int             LastRefresh;
/*0x023c*/ int                      PrimaryTintIndex;
/*0x0240*/ int                      ManaMax;
/*0x0244*/ bool                     bBuffTimersOnHold;
/*0x0248*/ int                      PetID;
/*0x024c*/ int                      SecondaryTintIndex;
/*0x0250*/ uint8_t                  CharClass;
/*0x0254*/ unsigned int             RespawnTimer;
/*0x0258*/ int                      Buyer;
/*0x025c*/ int                      ManaCurrent;
/*0x0260*/ float                    MissileRangeToTarget;
/*0x0264*/ uint8_t                  FindBits;
/*0x0268*/ int                      RealEstateID;
/*0x026c*/ char                     DragNames[2][0x40];
/*0x02ec*/ float                    MerchantGreed;
/*0x02f0*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x02f8*/ unsigned int             Zone;
/*0x02fc*/ unsigned int             LastRangedUsedTime;
/*0x0300*/ bool                     bShowHelm;
/*0x0304*/ unsigned int             LastPrimaryUseTime;
/*0x0308*/ CPhysicsInfo             LastCollision;
/*0x0338*/ int                      IsAttacking;
/*0x033c*/ int                      SomeData[2];
/*0x0344*/ uint8_t                  InPvPArea;
/*0x0348*/ unsigned int             SpellCooldownETA;
/*0x034c*/ uint8_t                  HoldingAnimation;
/*0x034d*/ uint8_t                  IntimidateCount;
/*0x0350*/ unsigned int             LastTimeStoodStill;
/*0x0354*/ bool                     bOfflineMode;
/*0x0358*/ int                      CurrIOState;
/*0x035c*/ float                    RunSpeed;
/*0x0360*/ bool                     bBetaBuffed;
/*0x0364*/ float                    GetMeleeRangeVar1;
/*0x0368*/ LaunchSpellData          CastingData;
/*0x03ac*/ int                      Unknown4;
/*0x03b0*/ bool                     bAnimationOnPop;
/*0x03b1*/ bool                     bSwitchMoved;
/*0x03b2*/ uint8_t                  Level;
/*0x03b4*/ unsigned int             NextSwim;
/*0x03b8*/ int                      AFK;
/*0x03bc*/ uint8_t                  FD;
/*0x03bd*/ uint8_t                  FishingEvent;
/*0x03c0*/ unsigned int**           ppUDP;
/*0x03c8*/ unsigned int             NextIntimidateTime;
/*0x03cc*/ uint8_t                  Light;
/*0x03d0*/ SPAWNINFO*               pViewPlayer;
/*0x03d8*/ int                      HideMode;
/*0x03dc*/ unsigned int             FishingETA;
/*0x03e0*/ bool                     bAttackRelated;
/*0x03e1*/ bool                     Linkdead;
/*0x03e2*/ char                     Suffix[0x80];
/*0x0462*/ char                     Handle[0x20];
/*0x0484*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x048c*/ bool                     PvPFlag;
/*0x048d*/ bool                     Sneak;
/*0x0490*/ unsigned int             Meditating;
/*0x0494*/ float                    CameraOffset;
/*0x0498*/ float                    MyWalkSpeed;
/*0x049c*/ unsigned int             LoginSerial;
/*0x04a0*/ bool                     LFG;
/*0x04a1*/ bool                     bStationary;
/*0x04a8*/ int64_t                  HPCurrent;
/*0x04b0*/ char                     GM;
/*0x04b4*/ unsigned int             SitStartTime;
/*0x04b8*/ void*                    pTouchingSwitch;
/*0x04c0*/ int                      Birthdate;
/*0x04c4*/ uint8_t                  IsPassenger;
/*0x04c8*/ unsigned int             EnduranceMax;
/*0x04d0*/ int64_t                  HPMax;
/*0x04d8*/ int                      Unknown1;
/*0x04dc*/ int                      berserker;
/*0x04e0*/ bool                     bTempPet;
/*0x04e4*/ unsigned int             LastSecondaryUseTime;
/*0x04e8*/ unsigned int             LastTick;
/*0x04ec*/ unsigned int             ACounter;
/*0x04f0*/ int                      EnduranceCurrent;
/*0x04f4*/ unsigned int             MinuteTimer;
/*0x04f8*/ unsigned int             SpellGemETA[15];
/*0x0534*/ char                     DraggingPlayer[0x40];
/*0x0574*/ char                     Title[0x80];
/*0x05f4*/ bool                     bAlwaysShowAura;
/*0x05f8*/ unsigned int             MasterID;
/*0x05fc*/ int                      RealEstateItemId;
/*0x0600*/ uint8_t                  Original;
/*0x0604*/ int                      Deity;
/*0x0608*/ int64_t                  GuildID;
/*0x0610*/ uint8_t                  Blind;
/*0x0618*/ CharacterZoneClient*     pCharacter;
/*0x0620*/ bool                     bSummoned;
/*0x0624*/ int                      WarCry;
/*0x0628*/ uint8_t                  LastAttack;
/*0x062c*/ unsigned int             LastResendAddPlayerPacket;
/*0x0630*/ uint8_t                  GMRank;
/*0x0638*/ void*                    pRaceGenderInfo;
/*0x0640*/ float                    FallingStartZ;
/*0x0644*/ int                      AltAttack;
/*0x0648*/ float                    BearingToTarget;
...
constexpr size_t PlayerClient_size = 0x20C8; // @sizeof(PlayerClient) :: 2025-10-07 (test) @ 0x1402FA99E
