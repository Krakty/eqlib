...
/*0x01cd*/ uint8_t                  InPvPArea;
/*0x01ce*/ char                     Title[0x80];
/*0x024e*/ bool                     bSwitchMoved;
/*0x0250*/ int                      EnduranceCurrent;
/*0x0254*/ int                      NpcTintIndex;
/*0x0258*/ int                      SomeData[2];
/*0x0260*/ unsigned int             MasterID;
/*0x0264*/ int                      Unknown1;
/*0x0268*/ uint8_t                  IntimidateCount;
/*0x0270*/ int64_t                  GuildID;
/*0x0278*/ unsigned int             SpellGemETA[15];
/*0x02b4*/ unsigned int             RespawnTimer;
/*0x02b8*/ unsigned int             LastRangedUsedTime;
/*0x02c0*/ void*                    pTouchingSwitch;
/*0x02c8*/ uint8_t                  IsPassenger;
/*0x02d0*/ unsigned int**           ppUDP;
/*0x02d8*/ float                    MyWalkSpeed;
/*0x02dc*/ float                    CameraOffset;
/*0x02e0*/ bool                     bStationary;
/*0x02e4*/ unsigned int             TimeStamp;
/*0x02e8*/ uint8_t                  GMRank;
/*0x02e9*/ uint8_t                  StandState;
/*0x02ec*/ int                      AltAttack;
/*0x02f0*/ unsigned int             LastRefresh;
/*0x02f4*/ int                      ManaMax;
/*0x02f8*/ bool                     bShowHelm;
/*0x02fc*/ unsigned int             SitStartTime;
/*0x0300*/ bool                     bOfflineMode;
/*0x0304*/ int                      Unknown4;
/*0x0308*/ unsigned int             LastSecondaryUseTime;
/*0x030c*/ unsigned int             SpellCooldownETA;
/*0x0310*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];
/*0x0318*/ float                    FallingStartZ;
/*0x031c*/ float                    RunSpeed;
/*0x0320*/ int                      PetID;
/*0x0324*/ float                    ViewHeight;
/*0x0328*/ bool                     bBuffTimersOnHold;
/*0x032c*/ float                    AnimationSpeedRelated;
/*0x0330*/ bool                     bAttackRelated;
/*0x0331*/ char                     GM;
/*0x0334*/ int                      Deity;
/*0x0338*/ int                      WarCry;
/*0x033c*/ bool                     PvPFlag;
/*0x0340*/ unsigned int             LastTick;
/*0x0344*/ uint8_t                  CharClass;
/*0x0345*/ char                     LoginRelated[0x20];
/*0x0368*/ int                      Anon;
/*0x036c*/ bool                     Sneak;
/*0x0370*/ int                      IsAttacking;
/*0x0374*/ uint8_t                  LastAttack;
/*0x0375*/ bool                     LFG;
/*0x0376*/ char                     DraggingPlayer[0x40];
/*0x03b6*/ uint8_t                  HoldingAnimation;
/*0x03b7*/ uint8_t                  Original;
/*0x03b8*/ int64_t                  HPMax;
/*0x03c0*/ int                      Birthdate;
/*0x03c4*/ int                      Unknown3;
/*0x03c8*/ int                      Trader;
/*0x03cc*/ unsigned int             StunTimer;
/*0x03d0*/ uint8_t                  FishingEvent;
/*0x03d8*/ int64_t                  HPCurrent;
/*0x03e0*/ char                     Handle[0x20];
/*0x0400*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x0408*/ float                    GetMeleeRangeVar1;
/*0x040c*/ LaunchSpellData          CastingData;
/*0x0450*/ unsigned int             LastResendAddPlayerPacket;
/*0x0454*/ bool                     bTempPet;
/*0x0455*/ bool                     bAnimationOnPop;
/*0x0458*/ SPAWNINFO*               pViewPlayer;
/*0x0460*/ bool                     Mercenary;
/*0x0464*/ float                    MissileRangeToTarget;
/*0x0468*/ unsigned int             LastMealTime;
/*0x046c*/ int                      DoSpecialMelee;
/*0x0470*/ unsigned int             LoginSerial;
/*0x0474*/ EqItemGuid               realEstateItemGuid;
/*0x0488*/ unsigned int             NextSwim;
/*0x0490*/ void*                    pRaceGenderInfo;
/*0x0498*/ unsigned int             NextIntimidateTime;
/*0x049c*/ bool                     bSummoned;
/*0x04a0*/ int                      RealEstateItemId;
/*0x04a4*/ int                      PrimaryTintIndex;
/*0x04a8*/ int                      HideMode;
/*0x04ac*/ unsigned int             LastTrapDamageTime;
/*0x04b0*/ unsigned int             EnduranceMax;
/*0x04b4*/ unsigned int             ACounter;
/*0x04b8*/ float                    MerchantGreed;
/*0x04bc*/ bool                     bAlwaysShowAura;
/*0x04c0*/ unsigned int             LastPrimaryUseTime;
/*0x04c4*/ unsigned int             FishingETA;
/*0x04c8*/ int                      CurrIOState;
/*0x04cc*/ unsigned int             LastTimeStoodStill;
/*0x04d0*/ uint8_t                  Blind;
/*0x04d1*/ char                     Suffix[0x80];
/*0x0551*/ uint8_t                  Level;
/*0x0554*/ int                      berserker;
/*0x0558*/ bool                     bBetaBuffed;
/*0x055c*/ int                      AFK;
/*0x0560*/ unsigned int             Meditating;
/*0x0564*/ uint8_t                  FD;
/*0x0565*/ char                     DragNames[2][0x40];
/*0x05e8*/ int                      ManaCurrent;
/*0x05ec*/ CPhysicsInfo             LastCollision;
/*0x061c*/ int                      RealEstateID;
/*0x0620*/ unsigned int             MinuteTimer;
/*0x0624*/ int                      SecondaryTintIndex;
/*0x0628*/ unsigned int             Zone;
/*0x062c*/ unsigned int             CorpseDragCount;
/*0x0630*/ uint8_t                  FindBits;
/*0x0634*/ float                    BearingToTarget;
/*0x0638*/ bool                     Linkdead;
/*0x063c*/ int                      Buyer;
/*0x0640*/ CharacterZoneClient*     pCharacter;
/*0x0648*/ uint8_t                  Light;
...
constexpr size_t PlayerClient_size = 0x20C8; // @sizeof(PlayerClient) :: 2025-07-23 (test) @ 0x1402F7BAE
