...
constexpr size_t ItemDefinition_size = 0x640; // @sizeof(ItemDefinition) :: 2025-08-13 (test) @ 0x14021757B
...
constexpr size_t ItemClient_size = 0x130; // @sizeof(ItemClient) :: 2025-08-13 (test) @ 0x1401E0E29
