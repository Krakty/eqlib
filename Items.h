...
constexpr size_t ItemDefinition_size = 0x640; // @sizeof(ItemDefinition) :: 2025-04-07 (test) @ 0x140215DCB
...
/*0x014*/ int                   RealEstateID;
/*0x018*/ unsigned int          ItemHash;
/*0x01c*/ int                   ActorTag1;
/*0x020*/ bool                  bDisableAugTexture;
/*0x024*/ int                   OrnamentationIcon;
/*0x028*/ bool                  bItemNeedsUpdate;
/*0x02c*/ int                   Luck;
/*0x030*/ int64_t               DontKnow;
/*0x038*/ unsigned int          LastCastTime;
/*0x03c*/ int                   AugFlag;
/*0x040*/ SoeUtil::String       SaveString;
/*0x058*/ int                   ScriptIndex;
/*0x05c*/ int                   Charges;
/*0x060*/ EqItemGuid            ItemGUID;
/*0x078*/ int64_t               MerchantSlot;
/*0x080*/ int                   StackCount;
/*0x084*/ int                   ActorTag2;
...
constexpr size_t ItemClient_size = 0x140; // @sizeof(ItemClient) :: 2025-04-07 (test) @ 0x1401E0869
