...
// @sizeof(ItemDefinition) == 0x640 :: 2024-11-12 (test) @ 0x14020db08
...
// @sizeof(ItemClient) == 0x130 :: 2024-11-12 (test) @ 0x1401d99f9
constexpr size_t ItemClient_size = 0x130;
