...
constexpr size_t ItemDefinition_size = 0x640; // @sizeof(ItemDefinition) :: 2025-03-19 (test) @ 0x140212EC8
...
constexpr size_t ItemClient_size = 0x138; // @sizeof(ItemClient) :: 2025-03-19 (test) @ 0x1401DDFE9
