...
constexpr size_t ItemDefinition_size = 0x640; // @sizeof(ItemDefinition) :: 2025-06-09 (test) @ 0x140215E5B
...
constexpr size_t ItemClient_size = 0x128; // @sizeof(ItemClient) :: 2025-06-09 (test) @ 0x1401E0679
