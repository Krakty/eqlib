...
constexpr size_t ItemDefinition_size = 0x640; // @sizeof(ItemDefinition) :: 2025-05-13 (test) @ 0x140215FCB
...
constexpr size_t ItemClient_size = 0x128; // @sizeof(ItemClient) :: 2025-05-13 (test) @ 0x1401E0359
