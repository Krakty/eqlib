...
constexpr size_t ItemDefinition_size = 0x640; // @sizeof(ItemDefinition) :: 2025-01-21 (test) @ 0x14020FAB8
...
constexpr size_t ItemClient_size = 0x128; // @sizeof(ItemClient) :: 2025-01-21 (test) @ 0x1401DAD69
