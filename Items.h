...
constexpr size_t ItemDefinition_size = 0x640; // @sizeof(ItemDefinition) :: 2025-09-24 (test) @ 0x140218CFB
...
constexpr size_t ItemClient_size = 0x130; // @sizeof(ItemClient) :: 2025-09-24 (test) @ 0x1401E1F39
