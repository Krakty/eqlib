...
constexpr size_t ItemDefinition_size = 0x640; // @sizeof(ItemDefinition) :: 2025-02-03 (test) @ 0x140211EC8
...
constexpr size_t ItemClient_size = 0x130; // @sizeof(ItemClient) :: 2025-02-03 (test) @ 0x1401DD239
