...
constexpr size_t CButtonWnd_size = 0x340; // @sizeof(CButtonWnd) :: 2025-02-07 (live) @ 0x1405C36E0
...
constexpr size_t CBuffWindow_size = 0x348; // @sizeof(CBuffWindow) :: 2025-02-07 (live) @ 0x14019064F
...
constexpr size_t CCursorAttachment_size = 0x620; // @sizeof(CCursorAttachment) :: 2025-02-07 (live) @ 0x14018F9E8
...
constexpr size_t CFindItemWnd_size = 0x3F0; // @sizeof(CFindItemWnd) :: 2025-02-07 (live) @ 0x140191076
...
constexpr size_t CFindLocationWnd_size = 0x7A0; // @sizeof(CFindLocationWnd) :: 2025-02-07 (live) @ 0x140191834
...
constexpr size_t CGiveWnd_size = 0xB18; // @sizeof(CGiveWnd) :: 2025-02-07 (live) @ 0x1401912E6
...
constexpr size_t CGroupWnd_size = 0x6F8; // @sizeof(CGroupWnd) :: 2025-02-07 (live) @ 0x140190167
...
constexpr size_t CItemDisplayWnd_size = 0xAA0; // @sizeof(CItemDisplayWnd) :: 2025-02-07 (live) @ 0x14041B1A4
...
constexpr size_t CKeyRingWnd_size = 0x460; // @sizeof(CKeyRingWnd) :: 2025-02-07 (live) @ 0x140190AD5
...
constexpr size_t CLootWnd_size = 0xCB8; // @sizeof(CLootWnd) :: 2025-02-07 (live) @ 0x140190DA4
...
constexpr size_t CMapViewWnd_size = 0x848; // @sizeof(CMapViewWnd) :: 2025-02-07 (live) @ 0x1401904C9
...
constexpr size_t CPetInfoWnd_size = 0x3C8; // @sizeof(CPetInfoWnd) :: 2025-02-07 (live) @ 0x14018FF8F
...
constexpr size_t CPlayerWnd_size = 0x400; // @sizeof(CPlayerWnd) :: 2025-02-07 (live) @ 0x1401908FD
...
constexpr size_t CSpellDisplayWnd_size = 0x3B0; // @sizeof(CSpellDisplayWnd) :: 2025-02-07 (live) @ 0x1404EB02E
...
constexpr size_t CTargetWnd_size = 0x3C0; // @sizeof(CTargetWnd) :: 2025-02-07 (live) @ 0x14019079E
...
constexpr size_t CTradeWnd_size = 0x16F0; // @sizeof(CTradeWnd) :: 2025-02-07 (live) @ 0x140190F8C
...
constexpr size_t ZoneGuideManagerClient_size = 0xF7C8; // @sizeof(ZoneGuideManagerClient) :: 2025-02-07 (live) @ 0x1403421DF
