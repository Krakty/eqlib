...
constexpr size_t CButtonWnd_size = 0x358; // @sizeof(CButtonWnd) :: 2025-07-07 (test) @ 0x1405D1370
...
constexpr size_t CBuffWindow_size = 0x360; // @sizeof(CBuffWindow) :: 2025-07-07 (test) @ 0x1401937AF
...
constexpr size_t CCursorAttachment_size = 0x638; // @sizeof(CCursorAttachment) :: 2025-07-07 (test) @ 0x140192B48
...
constexpr size_t CFindItemWnd_size = 0x408; // @sizeof(CFindItemWnd) :: 2025-07-07 (test) @ 0x1401941D6
...
constexpr size_t CFindLocationWnd_size = 0x7B8; // @sizeof(CFindLocationWnd) :: 2025-07-07 (test) @ 0x140194994
...
constexpr size_t CGiveWnd_size = 0xB30; // @sizeof(CGiveWnd) :: 2025-07-07 (test) @ 0x140194446
...
constexpr size_t CGroupWnd_size = 0x710; // @sizeof(CGroupWnd) :: 2025-07-07 (test) @ 0x1401932C7
...
constexpr size_t CItemDisplayWnd_size = 0xAB8; // @sizeof(CItemDisplayWnd) :: 2025-07-07 (test) @ 0x140424A64
...
constexpr size_t CKeyRingWnd_size = 0x478; // @sizeof(CKeyRingWnd) :: 2025-07-07 (test) @ 0x140193C35
...
/*0x3de*/ bool          bStatDirty[eNumPages];
/*0x3e4*/ int           ForcedSelection[eNumPages];
/*0x400*/ CButtonWnd*   pItemBtnTemplate;                // KRW_ItemBtnTemplate
/*0x408*/ CButtonWnd*   pBtnFamiliarLeave;               // KRW_Familiars_LeaveButton
/*0x410*/ CButtonWnd*   pBtnFamiliarAutoLeave;           // KRW_Familiars_AutoLeaveButton
/*0x418*/ CListWnd*     pKeysList;                       // KRW_Keys_List
/*0x420*/ bool          KeysListDirty;
/*0x424*/ int           ForcedKeysSelection;
/*0x428*/ int           LastUpdateTime;                  // timestamp of when the current tab was last updated.
/*0x430*/ CPageWnd*     pPageMounts;                     // KRW_Mounts_Page
/*0x438*/ CPageWnd*     pPageIllusions;                  // KRW_Illusions_Page
/*0x440*/ CPageWnd*     pPageFamiliars;                  // KRW_Familiars_Page
/*0x448*/ CPageWnd*     pPageKeys;                       // KRW_Keys_Page
/*0x450*/ CPageWnd*     pPageHeroForge;                  // KRW_HeroForge_Page
/*0x458*/ CPageWnd*     pPageTeleportation;              // KRW_TeleportationItems_Page
/*0x460*/ CPageWnd*     pPageActivated;                  // KRW_ActivatedItems_Page
/*0x468*/ CTabWnd*      pTabBox;                         // KRW_Subwindows
/*0x470*/ KeyRingPages  CurrentPage;
/*0x474*/
};
...
constexpr size_t CLootWnd_size = 0xCD0; // @sizeof(CLootWnd) :: 2025-07-07 (test) @ 0x140193F04
...
constexpr size_t CMapViewWnd_size = 0x878; // @sizeof(CMapViewWnd) :: 2025-07-07 (test) @ 0x140193629
...
constexpr size_t CPetInfoWnd_size = 0x3E0; // @sizeof(CPetInfoWnd) :: 2025-07-07 (test) @ 0x1401930EF
...
constexpr size_t CPlayerWnd_size = 0x418; // @sizeof(CPlayerWnd) :: 2025-07-07 (test) @ 0x140193A5D
...
constexpr size_t CSpellDisplayWnd_size = 0x3C8; // @sizeof(CSpellDisplayWnd) :: 2025-07-07 (test) @ 0x1404F525E
...
constexpr size_t CTargetWnd_size = 0x3D8; // @sizeof(CTargetWnd) :: 2025-07-07 (test) @ 0x1401938FE
...
constexpr size_t CTradeWnd_size = 0x1708; // @sizeof(CTradeWnd) :: 2025-07-07 (test) @ 0x1401940EC
...
/*0x09b8*/ UIButtonComponent  TradeButtonComponent;
/*0x0a58*/ UIButtonComponent  CancelButtonComponent;
/*0x0af8*/ UIStmlComponent    OtherNameComponent;
/*0x0b98*/ UIStmlComponent    SelfNameComponent;
/*0x0c38*/ UIInvSlotComponent TradeSlotComponent[16];

/*0x16b8*/ long               HisMoney[eNumMoneySlotTypes];
/*0x16c8*/ long               MyMoney[eNumMoneySlotTypes];
/*0x16d8*/ ItemContainer      TradeItems;
/*0x1700*/ bool               bHisReadyTrade;           // was HisTradeReady
/*0x1701*/ bool               bMyReadyTrade;            // was MyTradeReady
/*0x1702*/ bool               bIsTrading;               // was TradeWndOpen
/*0x1704*/
...
constexpr size_t ZoneGuideManagerClient_size = 0xF9C0; // @sizeof(ZoneGuideManagerClient) :: 2025-07-07 (test) @ 0x1403499BF
