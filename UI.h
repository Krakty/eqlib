...
constexpr size_t CButtonWnd_size = 0x348; // @sizeof(CButtonWnd) :: 2025-05-13 (test) @ 0x1405CEAB0
...
constexpr size_t CBuffWindow_size = 0x350; // @sizeof(CBuffWindow) :: 2025-05-13 (test) @ 0x1401933CF
...
constexpr size_t CCursorAttachment_size = 0x628; // @sizeof(CCursorAttachment) :: 2025-05-13 (test) @ 0x140192768
...
constexpr size_t CFindItemWnd_size = 0x3F8; // @sizeof(CFindItemWnd) :: 2025-05-13 (test) @ 0x140193DF6
...
constexpr size_t CFindLocationWnd_size = 0x7A8; // @sizeof(CFindLocationWnd) :: 2025-05-13 (test) @ 0x1401945B4
...
constexpr size_t CGiveWnd_size = 0xB20; // @sizeof(CGiveWnd) :: 2025-05-13 (test) @ 0x140194066
...
constexpr size_t CGroupWnd_size = 0x700; // @sizeof(CGroupWnd) :: 2025-05-13 (test) @ 0x140192EE7
...
constexpr size_t CItemDisplayWnd_size = 0xAA8; // @sizeof(CItemDisplayWnd) :: 2025-05-13 (test) @ 0x1404220E4
...
constexpr size_t CKeyRingWnd_size = 0x468; // @sizeof(CKeyRingWnd) :: 2025-05-13 (test) @ 0x140193855
...
/*0x398*/ CButtonWnd*   pBtnSlot[eNumPages];     // KRW_Mounts_SlotButton, KRW_Illusions_SlotButton, KRW_Familiars_SlotButton
/*0x3c8*/ bool          bListDirty[eNumPages];
/*0x3ce*/ bool          bStatDirty[eNumPages];
/*0x3d4*/ int           ForcedSelection[eNumPages];
/*0x3f0*/ CButtonWnd*   pItemBtnTemplate;                // KRW_ItemBtnTemplate
/*0x3f8*/ CButtonWnd*   pBtnFamiliarLeave;               // KRW_Familiars_LeaveButton
/*0x400*/ CButtonWnd*   pBtnFamiliarAutoLeave;           // KRW_Familiars_AutoLeaveButton
/*0x408*/ CListWnd*     pKeysList;                       // KRW_Keys_List
/*0x410*/ bool          KeysListDirty;
/*0x414*/ int           ForcedKeysSelection;
/*0x418*/ int           LastUpdateTime;                  // timestamp of when the current tab was last updated.
/*0x420*/ CPageWnd*     pPageMounts;                     // KRW_Mounts_Page
/*0x428*/ CPageWnd*     pPageIllusions;                  // KRW_Illusions_Page
/*0x430*/ CPageWnd*     pPageFamiliars;                  // KRW_Familiars_Page
/*0x438*/ CPageWnd*     pPageKeys;                       // KRW_Keys_Page
/*0x440*/ CPageWnd*     pPageHeroForge;                  // KRW_HeroForge_Page
/*0x448*/ CPageWnd*     pPageTeleportation;              // KRW_TeleportationItems_Page
/*0x450*/ CPageWnd*     pPageActivated;                  // KRW_ActivatedItems_Page
/*0x458*/ CTabWnd*      pTabBox;                         // KRW_Subwindows
/*0x460*/ KeyRingPages  CurrentPage;
/*0x464*/
};
...
constexpr size_t CLootWnd_size = 0xCC0; // @sizeof(CLootWnd) :: 2025-05-13 (test) @ 0x140193B24
...
constexpr size_t CMapViewWnd_size = 0x858; // @sizeof(CMapViewWnd) :: 2025-05-13 (test) @ 0x140193249
...
constexpr size_t CPetInfoWnd_size = 0x3D0; // @sizeof(CPetInfoWnd) :: 2025-05-13 (test) @ 0x140192D0F
...
constexpr size_t CPlayerWnd_size = 0x408; // @sizeof(CPlayerWnd) :: 2025-05-13 (test) @ 0x14019367D
...
constexpr size_t CSpellDisplayWnd_size = 0x3B8; // @sizeof(CSpellDisplayWnd) :: 2025-05-13 (test) @ 0x1404F27DE
...
constexpr size_t CTargetWnd_size = 0x3C8; // @sizeof(CTargetWnd) :: 2025-05-13 (test) @ 0x14019351E
...
constexpr size_t CTradeWnd_size = 0x16F8; // @sizeof(CTradeWnd) :: 2025-05-13 (test) @ 0x140193D0C
...
/*0x16f2*/ bool               bIsTrading;               // was TradeWndOpen
/*0x16f4*/
...
constexpr size_t ZoneGuideManagerClient_size = 0xF9C0; // @sizeof(ZoneGuideManagerClient) :: 2025-05-13 (test) @ 0x1403480CF
