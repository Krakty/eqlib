...
constexpr size_t EQ_Spell_size = 0x210; // @sizeof(EQ_Spell) :: 2024-12-13 (test) @ 0x1401D30A7
...
constexpr size_t ClientSpellManager_size = 0x424BA0; // @sizeof(ClientSpellManager) :: 2024-12-13 (test) @ 0x14026253B
