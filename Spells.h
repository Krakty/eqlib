...
constexpr size_t EQ_Spell_size = 0x214; // @sizeof(EQ_Spell) :: 2025-09-08 (test) @ 0x1401D9FB7
...
constexpr size_t ClientSpellManager_size = 0x22A0; // @sizeof(ClientSpellManager) :: 2025-09-08 (test) @ 0x14026DEE0
