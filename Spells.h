...
constexpr size_t EQ_Spell_size = 0x210; // @sizeof(EQ_Spell) :: 2025-01-07 (test) @ 0x1401D3987
...
constexpr size_t ClientSpellManager_size = 0x424BA0; // @sizeof(ClientSpellManager) :: 2025-01-07 (test) @ 0x14026355B
