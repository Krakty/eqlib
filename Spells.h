...
constexpr size_t EQ_Spell_size = 0x210; // @sizeof(EQ_Spell) :: 2025-03-04 (test) @ 0x1401D6A27
...
constexpr size_t ClientSpellManager_size = 0x2290; // @sizeof(ClientSpellManager) :: 2025-03-04 (test) @ 0x140266E0B
