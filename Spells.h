...
constexpr size_t EQ_Spell_size = 0x214; // @sizeof(EQ_Spell) :: 2025-08-14 (test) @ 0x1401D9347
...
constexpr size_t ClientSpellManager_size = 0x22A0; // @sizeof(ClientSpellManager) :: 2025-08-14 (test) @ 0x14026C0B0
