...
constexpr size_t EQ_Spell_size = 0x214; // @sizeof(EQ_Spell) :: 2025-06-09 (test) @ 0x1401D8F37
...
constexpr size_t ClientSpellManager_size = 0x22A0; // @sizeof(ClientSpellManager) :: 2025-06-09 (test) @ 0x14026A9AB
